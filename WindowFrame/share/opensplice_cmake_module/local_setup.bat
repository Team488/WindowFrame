...
set "AMENT_ENVIRONMENT_HOOKS[opensplice_cmake_module]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[opensplice_cmake_module] "%AMENT_CURRENT_PREFIX%\share\opensplice_cmake_module\environment\ament_prefix_path.bat"
::call:ament_append_value AMENT_ENVIRONMENT_HOOKS[opensplice_cmake_module] "%AMENT_CURRENT_PREFIX%\share\opensplice_cmake_module\environment\opensplice.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[opensplice_cmake_module] "%AMENT_CURRENT_PREFIX%\share\opensplice_cmake_module\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[opensplice_cmake_module]:;=";"%") do (
    call:call_file %%f
  )
