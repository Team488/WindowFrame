...
set "AMENT_ENVIRONMENT_HOOKS[action_tutorials]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[action_tutorials] "%AMENT_CURRENT_PREFIX%\share\action_tutorials\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[action_tutorials] "%AMENT_CURRENT_PREFIX%\share\action_tutorials\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[action_tutorials] "%AMENT_CURRENT_PREFIX%\share\action_tutorials\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[action_tutorials]:;=";"%") do (
    call:call_file %%f
  )
