...
if (NOT TARGET Qt5::lrelease)
    ...
    set(imported_location "${_qt5_linguisttools_install_prefix}/tools/qt5-tools/lrelease.exe")
...
if (NOT TARGET Qt5::lupdate)
    ...
    set(imported_location "${_qt5_linguisttools_install_prefix}/tools/qt5-tools/lupdate.exe")
    _qt5_LinguistTools_check_file_exists(${imported_location})
...
if (NOT TARGET Qt5::lconvert)
    ...
    set(imported_location "${_qt5_linguisttools_install_prefix}/tools/qt5-tools/lconvert.exe")
    _qt5_LinguistTools_check_file_exists(${imported_location})
