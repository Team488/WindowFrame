...
set "AMENT_ENVIRONMENT_HOOKS[resource_retriever]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[resource_retriever] "%AMENT_CURRENT_PREFIX%\share\resource_retriever\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[resource_retriever] "%AMENT_CURRENT_PREFIX%\share\resource_retriever\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[resource_retriever]:;=";"%") do (
    call:call_file %%f
  )
