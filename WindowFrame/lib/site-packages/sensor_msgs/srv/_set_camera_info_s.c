...
bool sensor_msgs__srv__set_camera_info__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "sensor_msgs.srv._set_camera_info.SetCameraInfo_Request",
...
bool sensor_msgs__srv__set_camera_info__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "sensor_msgs.srv._set_camera_info.SetCameraInfo_Response",
  ...
  {  // status_message
    ...
    rosidl_generator_c__String__assign(&ros_message->status_message, PyBytes_AS_STRING(encoded_field));
