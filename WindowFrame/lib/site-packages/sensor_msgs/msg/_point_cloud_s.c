...
bool sensor_msgs__msg__channel_float32__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * sensor_msgs__msg__channel_float32__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool sensor_msgs__msg__point_cloud__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  sensor_msgs__msg__PointCloud * ros_message = _ros_message;
  {  // header
  ...
  {  // channels
    ...
    if (!sensor_msgs__msg__ChannelFloat32__Sequence__init(&(ros_message->channels), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create sensor_msgs__msg__ChannelFloat32__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    sensor_msgs__msg__ChannelFloat32 * dest = ros_message->channels.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!sensor_msgs__msg__channel_float32__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * sensor_msgs__msg__point_cloud__convert_to_py(void * raw_ros_message)
{
  ...
  {  // channels
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = sensor_msgs__msg__channel_float32__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
