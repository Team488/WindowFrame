...
bool sensor_msgs__msg__fluid_pressure__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  sensor_msgs__msg__FluidPressure * ros_message = _ros_message;
  {  // header
  ...
  {  // fluid_pressure
    PyObject * field = PyObject_GetAttrString(_pymsg, "fluid_pressure");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->fluid_pressure = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // variance
...
PyObject * sensor_msgs__msg__fluid_pressure__convert_to_py(void * raw_ros_message)
{
  ...
  {  // fluid_pressure
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->fluid_pressure);
    {
      int rc = PyObject_SetAttrString(_pymessage, "fluid_pressure", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
