...
bool sensor_msgs__msg__relative_humidity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  sensor_msgs__msg__RelativeHumidity * ros_message = _ros_message;
  {  // header
  ...
  {  // relative_humidity
    PyObject * field = PyObject_GetAttrString(_pymsg, "relative_humidity");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->relative_humidity = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // variance
...
PyObject * sensor_msgs__msg__relative_humidity__convert_to_py(void * raw_ros_message)
{
  ...
  {  // relative_humidity
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->relative_humidity);
    {
      int rc = PyObject_SetAttrString(_pymessage, "relative_humidity", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
