...
bool sensor_msgs__msg__laser_echo__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  sensor_msgs__msg__LaserEcho * ros_message = _ros_message;
  {  // echoes
    PyObject * field = PyObject_GetAttrString(_pymsg, "echoes");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'echoes'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!rosidl_generator_c__float__Sequence__init(&(ros_message->echoes), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create float__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    float * dest = ros_message->echoes.data;
...
PyObject * sensor_msgs__msg__laser_echo__convert_to_py(void * raw_ros_message)
{
  ...
  {  // echoes
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "echoes");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->echoes.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->echoes.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->echoes.size * sizeof(float));
      assert(data != NULL);
