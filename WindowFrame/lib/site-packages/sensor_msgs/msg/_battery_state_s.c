...
bool sensor_msgs__msg__battery_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // location
    ...
    rosidl_generator_c__String__assign(&ros_message->location, PyBytes_AS_STRING(encoded_field));
  ...
  {  // serial_number
    ...
    rosidl_generator_c__String__assign(&ros_message->serial_number, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
