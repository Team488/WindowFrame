...
bool sensor_msgs__msg__camera_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  sensor_msgs__msg__CameraInfo * ros_message = _ros_message;
  {  // header
  ...
  {  // distortion_model
    ...
    rosidl_generator_c__String__assign(&ros_message->distortion_model, PyBytes_AS_STRING(encoded_field));
  ...
  {  // d
    ...
    if (!rosidl_generator_c__double__Sequence__init(&(ros_message->d), size)) {
