...
bool sensor_msgs__msg__magnetic_field__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  sensor_msgs__msg__MagneticField * ros_message = _ros_message;
  {  // header
  ...
  {  // magnetic_field_covariance
    PyObject * field = PyObject_GetAttrString(_pymsg, "magnetic_field_covariance");
    if (!field) {
      return false;
    }
    ...
    Py_ssize_t size = 9;
    double * dest = ros_message->magnetic_field_covariance;
...
PyObject * sensor_msgs__msg__magnetic_field__convert_to_py(void * raw_ros_message)
{
  ...
  {  // magnetic_field_covariance
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "magnetic_field_covariance");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    double * src = &(ros_message->magnetic_field_covariance[0]);
