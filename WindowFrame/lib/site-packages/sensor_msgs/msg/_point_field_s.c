...
bool sensor_msgs__msg__point_field__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  sensor_msgs__msg__PointField * ros_message = _ros_message;
  {  // name
  ...
  {  // datatype
    ...
    assert(PyLong_Check(field));
    ros_message->datatype = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // count
...
PyObject * sensor_msgs__msg__point_field__convert_to_py(void * raw_ros_message)
{
  ...
  {  // datatype
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->datatype);
    {
