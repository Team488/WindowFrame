...
bool sensor_msgs__msg__joint_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  sensor_msgs__msg__JointState * ros_message = _ros_message;
  {  // header
  ...
  {  // name
    ...
    if (!rosidl_generator_c__String__Sequence__init(&(ros_message->name), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create String__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rosidl_generator_c__String * dest = ros_message->name.data;
...
PyObject * sensor_msgs__msg__joint_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // name
    ...
    rosidl_generator_c__String * src = ros_message->name.data;
