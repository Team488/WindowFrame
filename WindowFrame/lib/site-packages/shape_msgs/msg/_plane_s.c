...
bool shape_msgs__msg__plane__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  shape_msgs__msg__Plane * ros_message = _ros_message;
  {  // coef
    PyObject * field = PyObject_GetAttrString(_pymsg, "coef");
    if (!field) {
      return false;
    }
...
PyObject * shape_msgs__msg__plane__convert_to_py(void * raw_ros_message)
{
  ...
  {  // coef
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "coef");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
