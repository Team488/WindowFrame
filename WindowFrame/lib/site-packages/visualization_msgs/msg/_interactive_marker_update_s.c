...
bool visualization_msgs__msg__interactive_marker_update__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "visualization_msgs.msg._interactive_marker_update.InteractiveMarkerUpdate",
  ...
  {  // server_id
    ...
    rosidl_generator_c__String__assign(&ros_message->server_id, PyBytes_AS_STRING(encoded_field));
  ...
  {  // erases
    ...
    if (!rosidl_generator_c__String__Sequence__init(&(ros_message->erases), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create String__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rosidl_generator_c__String * dest = ros_message->erases.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * visualization_msgs__msg__interactive_marker_update__convert_to_py(void * raw_ros_message)
{
  ...
  {  // erases
    ...
    rosidl_generator_c__String * src = ros_message->erases.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
