...
bool visualization_msgs__msg__marker_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "visualization_msgs.msg._marker_array.MarkerArray",
        full_classname_dest, 48) == 0);
  }
  visualization_msgs__msg__MarkerArray * ros_message = _ros_message;
  {  // markers
...
PyObject * visualization_msgs__msg__marker_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("visualization_msgs.msg._marker_array");
