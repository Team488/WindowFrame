...
bool visualization_msgs__msg__menu_entry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "visualization_msgs.msg._menu_entry.MenuEntry",
        full_classname_dest, 44) == 0);
  }
  visualization_msgs__msg__MenuEntry * ros_message = _ros_message;
  {  // id
  ...
  {  // title
    ...
    rosidl_generator_c__String__assign(&ros_message->title, PyBytes_AS_STRING(encoded_field));
  ...
  {  // command
    ...
    rosidl_generator_c__String__assign(&ros_message->command, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // command_type
...
{
  /* NOTE(esteve): Call constructor of MenuEntry */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("visualization_msgs.msg._menu_entry");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MenuEntry");
