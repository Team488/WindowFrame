...
bool visualization_msgs__msg__interactive_marker_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "visualization_msgs.msg._interactive_marker_pose.InteractiveMarkerPose",
        full_classname_dest, 69) == 0);
  }
  visualization_msgs__msg__InteractiveMarkerPose * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of InteractiveMarkerPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("visualization_msgs.msg._interactive_marker_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "InteractiveMarkerPose");
