...
bool visualization_msgs__msg__marker__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "visualization_msgs.msg._marker.Marker",
  ...
  {  // ns
    ...
    rosidl_generator_c__String__assign(&ros_message->ns, PyBytes_AS_STRING(encoded_field));
  ...
  {  // text
    ...
    rosidl_generator_c__String__assign(&ros_message->text, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // mesh_resource
    ...
    rosidl_generator_c__String__assign(&ros_message->mesh_resource, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
