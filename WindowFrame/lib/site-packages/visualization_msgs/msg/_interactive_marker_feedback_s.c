...
bool visualization_msgs__msg__interactive_marker_feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "visualization_msgs.msg._interactive_marker_feedback.InteractiveMarkerFeedback",
  ...
  {  // client_id
    ...
    rosidl_generator_c__String__assign(&ros_message->client_id, PyBytes_AS_STRING(encoded_field));
  ...
  {  // marker_name
    ...
    rosidl_generator_c__String__assign(&ros_message->marker_name, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // control_name
    ...
    rosidl_generator_c__String__assign(&ros_message->control_name, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // event_type
