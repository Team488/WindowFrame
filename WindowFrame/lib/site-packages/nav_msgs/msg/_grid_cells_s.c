...
bool nav_msgs__msg__grid_cells__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  nav_msgs__msg__GridCells * ros_message = _ros_message;
  {  // header
  ...
  {  // cell_width
    PyObject * field = PyObject_GetAttrString(_pymsg, "cell_width");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->cell_width = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // cell_height
    PyObject * field = PyObject_GetAttrString(_pymsg, "cell_height");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->cell_height = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // cells
    ...
    geometry_msgs__msg__Point * dest = ros_message->cells.data;
...
PyObject * nav_msgs__msg__grid_cells__convert_to_py(void * raw_ros_message)
{
  ...
  {  // cell_width
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->cell_width);
    {
      int rc = PyObject_SetAttrString(_pymessage, "cell_width", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // cell_height
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->cell_height);
    {
      int rc = PyObject_SetAttrString(_pymessage, "cell_height", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
