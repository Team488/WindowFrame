...
bool rcl_interfaces__msg__list_parameters_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  rcl_interfaces__msg__ListParametersResult * ros_message = _ros_message;
  {  // names
    ...
    if (!rosidl_generator_c__String__Sequence__init(&(ros_message->names), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create String__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rosidl_generator_c__String * dest = ros_message->names.data;
  ...
  {  // prefixes
    ...
    if (!rosidl_generator_c__String__Sequence__init(&(ros_message->prefixes), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create String__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rosidl_generator_c__String * dest = ros_message->prefixes.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
...
PyObject * rcl_interfaces__msg__list_parameters_result__convert_to_py(void * raw_ros_message)
{
  ...
  {  // names
    ...
    rosidl_generator_c__String * src = ros_message->names.data;
  ...
  {  // prefixes
    ...
    rosidl_generator_c__String * src = ros_message->prefixes.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
