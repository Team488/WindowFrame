...
bool rcl_interfaces__msg__log__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // msg
    ...
    rosidl_generator_c__String__assign(&ros_message->msg, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // file
    ...
    rosidl_generator_c__String__assign(&ros_message->file, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // function
    ...
    rosidl_generator_c__String__assign(&ros_message->function, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // line
