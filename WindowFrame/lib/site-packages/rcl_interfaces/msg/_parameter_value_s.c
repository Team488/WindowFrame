...
bool rcl_interfaces__msg__parameter_value__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // byte_array_value
    ...
    if (!rosidl_generator_c__octet__Sequence__init(&(ros_message->byte_array_value), size)) {
  ...
  {  // bool_array_value
    ...
    if (!rosidl_generator_c__boolean__Sequence__init(&(ros_message->bool_array_value), size)) {
  ...
  {  // integer_array_value
    ...
    if (!rosidl_generator_c__int64__Sequence__init(&(ros_message->integer_array_value), size)) {
  ...
  {  // double_array_value
    ...
    if (!rosidl_generator_c__double__Sequence__init(&(ros_message->double_array_value), size)) {
  ...
  {  // string_array_value
    ...
    if (!rosidl_generator_c__String__Sequence__init(&(ros_message->string_array_value), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create String__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rosidl_generator_c__String * dest = ros_message->string_array_value.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
...
PyObject * rcl_interfaces__msg__parameter_value__convert_to_py(void * raw_ros_message)
{
  ...
  {  // string_array_value
    ...
    rosidl_generator_c__String * src = ros_message->string_array_value.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
