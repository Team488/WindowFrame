...
bool rcl_interfaces__msg__parameter_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  rcl_interfaces__msg__ParameterType * ros_message = _ros_message;
