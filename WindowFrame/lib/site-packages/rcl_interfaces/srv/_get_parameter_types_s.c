...
bool rcl_interfaces__srv__get_parameter_types__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "rcl_interfaces.srv._get_parameter_types.GetParameterTypes_Request",
...
bool rcl_interfaces__srv__get_parameter_types__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "rcl_interfaces.srv._get_parameter_types.GetParameterTypes_Response",
  ...
  {  // types
    ...
    if (!rosidl_generator_c__uint8__Sequence__init(&(ros_message->types), size)) {
