...
bool tf2_msgs__action__lookup_transform__goal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tf2_msgs.action._lookup_transform.LookupTransform_Goal",
  ...
  {  // target_frame
    ...
    rosidl_generator_c__String__assign(&ros_message->target_frame, PyBytes_AS_STRING(encoded_field));
  ...
  {  // source_frame
    ...
    rosidl_generator_c__String__assign(&ros_message->source_frame, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // source_time
  ...
  {  // fixed_frame
    ...
    rosidl_generator_c__String__assign(&ros_message->fixed_frame, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // advanced
...
bool tf2_msgs__action__lookup_transform__result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tf2_msgs.action._lookup_transform.LookupTransform_Result",
...
bool tf2_msgs__action__lookup_transform__feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tf2_msgs.action._lookup_transform.LookupTransform_Feedback",
...
bool tf2_msgs__action__lookup_transform__send_goal__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tf2_msgs.action._lookup_transform.LookupTransform_SendGoal_Request",
...
bool tf2_msgs__action__lookup_transform__send_goal__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tf2_msgs.action._lookup_transform.LookupTransform_SendGoal_Response",
...
bool tf2_msgs__action__lookup_transform__get_result__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tf2_msgs.action._lookup_transform.LookupTransform_GetResult_Request",
        full_classname_dest, 67) == 0);
  }
...
bool tf2_msgs__action__lookup_transform__get_result__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tf2_msgs.action._lookup_transform.LookupTransform_GetResult_Response",
...
bool tf2_msgs__action__lookup_transform__feedback_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tf2_msgs.action._lookup_transform.LookupTransform_FeedbackMessage",
