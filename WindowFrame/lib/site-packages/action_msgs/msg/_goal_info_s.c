...
bool action_msgs__msg__goal_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "action_msgs.msg._goal_info.GoalInfo",
        full_classname_dest, 35) == 0);
  }
  action_msgs__msg__GoalInfo * ros_message = _ros_message;
  {  // goal_id
...
PyObject * action_msgs__msg__goal_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("action_msgs.msg._goal_info");
