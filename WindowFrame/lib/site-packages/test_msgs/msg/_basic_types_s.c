...
bool test_msgs__msg__basic_types__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "test_msgs.msg._basic_types.BasicTypes",
        full_classname_dest, 37) == 0);
  }
  test_msgs__msg__BasicTypes * ros_message = _ros_message;
  {  // bool_value
...
PyObject * test_msgs__msg__basic_types__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("test_msgs.msg._basic_types");
