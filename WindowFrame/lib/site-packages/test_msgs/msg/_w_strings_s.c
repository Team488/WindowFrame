...
bool test_msgs__msg__w_strings__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "test_msgs.msg._w_strings.WStrings",
  ...
  {  // wstring_value
    ...
    {
      bool succeeded = rosidl_generator_c__U16String__assignn_from_char(&ros_message->wstring_value, buffer + 2, length - 2);
      if (!succeeded) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // wstring_value_default1
    ...
    // use offset of 2 to skip BOM mark
    {
      bool succeeded = rosidl_generator_c__U16String__assignn_from_char(&ros_message->wstring_value_default1, buffer + 2, length - 2);
      if (!succeeded) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // wstring_value_default2
    ...
    // use offset of 2 to skip BOM mark
    {
      bool succeeded = rosidl_generator_c__U16String__assignn_from_char(&ros_message->wstring_value_default2, buffer + 2, length - 2);
      if (!succeeded) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // wstring_value_default3
    ...
    // use offset of 2 to skip BOM mark
    {
      bool succeeded = rosidl_generator_c__U16String__assignn_from_char(&ros_message->wstring_value_default3, buffer + 2, length - 2);
      if (!succeeded) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // array_of_wstrings
    ...
    Py_ssize_t size = 3;
    rosidl_generator_c__U16String * dest = ros_message->array_of_wstrings;
  ...
  {  // bounded_sequence_of_wstrings
    ...
    rosidl_generator_c__U16String * dest = ros_message->bounded_sequence_of_wstrings.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
  ...
  {  // unbounded_sequence_of_wstrings
    ...
    rosidl_generator_c__U16String * dest = ros_message->unbounded_sequence_of_wstrings.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
...
PyObject * test_msgs__msg__w_strings__convert_to_py(void * raw_ros_message)
{
  ...
  {  // array_of_wstrings
    PyObject * field = NULL;
    size_t size = 3;
    rosidl_generator_c__U16String * src = ros_message->array_of_wstrings;
  ...
  {  // bounded_sequence_of_wstrings
    ...
    rosidl_generator_c__U16String * src = ros_message->bounded_sequence_of_wstrings.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // unbounded_sequence_of_wstrings
    ...
    rosidl_generator_c__U16String * src = ros_message->unbounded_sequence_of_wstrings.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
