...
bool test_msgs__msg__unbounded_sequences__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "test_msgs.msg._unbounded_sequences.UnboundedSequences",
  ...
  {  // string_values
    ...
    rosidl_generator_c__String * dest = ros_message->string_values.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
  ...
  {  // string_values_default
    ...
    rosidl_generator_c__String * dest = ros_message->string_values_default.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
...
PyObject * test_msgs__msg__unbounded_sequences__convert_to_py(void * raw_ros_message)
{
  ...
  {  // string_values
    ...
    rosidl_generator_c__String * src = ros_message->string_values.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // string_values_default
    ...
    rosidl_generator_c__String * src = ros_message->string_values_default.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
