...
bool test_msgs__srv__arrays__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "test_msgs.srv._arrays.Arrays_Request",
  ...
  {  // string_values
    ...
    Py_ssize_t size = 3;
    rosidl_generator_c__String * dest = ros_message->string_values;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
  ...
  {  // string_values_default
    ...
    Py_ssize_t size = 3;
    rosidl_generator_c__String * dest = ros_message->string_values_default;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
...
PyObject * test_msgs__srv__arrays__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // string_values
    PyObject * field = NULL;
    size_t size = 3;
    rosidl_generator_c__String * src = ros_message->string_values;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // string_values_default
    PyObject * field = NULL;
    size_t size = 3;
    rosidl_generator_c__String * src = ros_message->string_values_default;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
...
bool test_msgs__srv__arrays__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "test_msgs.srv._arrays.Arrays_Response",
