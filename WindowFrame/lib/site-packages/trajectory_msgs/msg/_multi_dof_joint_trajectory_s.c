...
bool trajectory_msgs__msg__multi_dof_joint_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "trajectory_msgs.msg._multi_dof_joint_trajectory.MultiDOFJointTrajectory",
        full_classname_dest, 71) == 0);
  }
  trajectory_msgs__msg__MultiDOFJointTrajectory * ros_message = _ros_message;
  {  // header
  ...
  {  // joint_names
    ...
    rosidl_generator_c__String * dest = ros_message->joint_names.data;
  ...
  {  // points
    ...
    if (!trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence__init(&(ros_message->points), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    trajectory_msgs__msg__MultiDOFJointTrajectoryPoint * dest = ros_message->points.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!trajectory_msgs__msg__multi_dof_joint_trajectory_point__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of MultiDOFJointTrajectory */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("trajectory_msgs.msg._multi_dof_joint_trajectory");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MultiDOFJointTrajectory");
  ...
  trajectory_msgs__msg__MultiDOFJointTrajectory * ros_message = (trajectory_msgs__msg__MultiDOFJointTrajectory *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
  ...
  {  // joint_names
    ...
    rosidl_generator_c__String * src = ros_message->joint_names.data;
  ...
  {  // points
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = trajectory_msgs__msg__multi_dof_joint_trajectory_point__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
