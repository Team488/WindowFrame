...
bool trajectory_msgs__msg__joint_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "trajectory_msgs.msg._joint_trajectory.JointTrajectory",
        full_classname_dest, 53) == 0);
  }
  trajectory_msgs__msg__JointTrajectory * ros_message = _ros_message;
  {  // header
  ...
  {  // points
    ...
    trajectory_msgs__msg__JointTrajectoryPoint * dest = ros_message->points.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * trajectory_msgs__msg__joint_trajectory__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("trajectory_msgs.msg._joint_trajectory");
  ...
  trajectory_msgs__msg__JointTrajectory * ros_message = (trajectory_msgs__msg__JointTrajectory *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
