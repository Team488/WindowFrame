...
bool map_msgs__msg__projected_map_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "map_msgs.msg._projected_map_info.ProjectedMapInfo",
        full_classname_dest, 49) == 0);
  }
  map_msgs__msg__ProjectedMapInfo * ros_message = _ros_message;
  {  // frame_id
    ...
    rosidl_generator_c__String__assign(&ros_message->frame_id, PyBytes_AS_STRING(encoded_field));
...
{
  /* NOTE(esteve): Call constructor of ProjectedMapInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("map_msgs.msg._projected_map_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ProjectedMapInfo");
