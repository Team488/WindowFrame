...
bool map_msgs__msg__occupancy_grid_update__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "map_msgs.msg._occupancy_grid_update.OccupancyGridUpdate",
        full_classname_dest, 55) == 0);
  }
  map_msgs__msg__OccupancyGridUpdate * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of OccupancyGridUpdate */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("map_msgs.msg._occupancy_grid_update");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OccupancyGridUpdate");
