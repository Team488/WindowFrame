...
bool composition_interfaces__srv__load_node__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "composition_interfaces.srv._load_node.LoadNode_Request",
  ...
  {  // package_name
    ...
    rosidl_generator_c__String__assign(&ros_message->package_name, PyBytes_AS_STRING(encoded_field));
  ...
  {  // plugin_name
    ...
    rosidl_generator_c__String__assign(&ros_message->plugin_name, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // node_name
    ...
    rosidl_generator_c__String__assign(&ros_message->node_name, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // node_namespace
    ...
    rosidl_generator_c__String__assign(&ros_message->node_namespace, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // log_level
  ...
  {  // remap_rules
    ...
    if (!rosidl_generator_c__String__Sequence__init(&(ros_message->remap_rules), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create String__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rosidl_generator_c__String * dest = ros_message->remap_rules.data;
...
PyObject * composition_interfaces__srv__load_node__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // remap_rules
    ...
    rosidl_generator_c__String * src = ros_message->remap_rules.data;
...
bool composition_interfaces__srv__load_node__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "composition_interfaces.srv._load_node.LoadNode_Response",
  ...
  {  // error_message
    ...
    rosidl_generator_c__String__assign(&ros_message->error_message, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // full_node_name
    ...
    rosidl_generator_c__String__assign(&ros_message->full_node_name, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // unique_id
