...
#ifndef GEOMETRY_MSGS__MSG__POSE_WITH_COVARIANCE__STRUCT_HPP_
#define GEOMETRY_MSGS__MSG__POSE_WITH_COVARIANCE__STRUCT_HPP_
...
struct PoseWithCovariance_
{
  ...
  explicit PoseWithCovariance_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : pose(_init)
  {
  ...
  explicit PoseWithCovariance_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : pose(_alloc, _init),
    covariance(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
#endif  // GEOMETRY_MSGS__MSG__POSE_WITH_COVARIANCE__STRUCT_HPP_
