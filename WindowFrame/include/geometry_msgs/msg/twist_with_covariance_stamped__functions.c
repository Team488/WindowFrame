...
{
  geometry_msgs__msg__TwistWithCovarianceStamped__Sequence * array = (geometry_msgs__msg__TwistWithCovarianceStamped__Sequence *)malloc(sizeof(geometry_msgs__msg__TwistWithCovarianceStamped__Sequence));
  if (!array) {
    return NULL;
  }
