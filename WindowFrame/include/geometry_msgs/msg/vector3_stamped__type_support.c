...
void Vector3Stamped__rosidl_typesupport_introspection_c__Vector3Stamped_init_function(
...
void Vector3Stamped__rosidl_typesupport_introspection_c__Vector3Stamped_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers Vector3Stamped__rosidl_typesupport_introspection_c__Vector3Stamped_message_members = {
  ...
  Vector3Stamped__rosidl_typesupport_introspection_c__Vector3Stamped_init_function,  // function to initialize message memory (memory has to be allocated)
  Vector3Stamped__rosidl_typesupport_introspection_c__Vector3Stamped_fini_function  // function to terminate message instance (will not free memory)
};
