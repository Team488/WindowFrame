...
#ifndef GEOMETRY_MSGS__MSG__ACCEL_WITH_COVARIANCE__FUNCTIONS_H_
#define GEOMETRY_MSGS__MSG__ACCEL_WITH_COVARIANCE__FUNCTIONS_H_
...
#endif  // GEOMETRY_MSGS__MSG__ACCEL_WITH_COVARIANCE__FUNCTIONS_H_
