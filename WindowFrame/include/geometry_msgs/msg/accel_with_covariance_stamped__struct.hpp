...
#ifndef GEOMETRY_MSGS__MSG__ACCEL_WITH_COVARIANCE_STAMPED__STRUCT_HPP_
#define GEOMETRY_MSGS__MSG__ACCEL_WITH_COVARIANCE_STAMPED__STRUCT_HPP_
...
struct AccelWithCovarianceStamped_
{
  ...
  explicit AccelWithCovarianceStamped_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    accel(_init)
  {
    (void)_init;
  ...
  explicit AccelWithCovarianceStamped_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    accel(_alloc, _init)
  {
    (void)_init;
...
#endif  // GEOMETRY_MSGS__MSG__ACCEL_WITH_COVARIANCE_STAMPED__STRUCT_HPP_
