...
#ifndef GEOMETRY_MSGS__MSG__TWIST_WITH_COVARIANCE_STAMPED__STRUCT_HPP_
#define GEOMETRY_MSGS__MSG__TWIST_WITH_COVARIANCE_STAMPED__STRUCT_HPP_
...
struct TwistWithCovarianceStamped_
{
  ...
  explicit TwistWithCovarianceStamped_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    twist(_init)
  {
    (void)_init;
  ...
  explicit TwistWithCovarianceStamped_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    twist(_alloc, _init)
  {
    (void)_init;
...
#endif  // GEOMETRY_MSGS__MSG__TWIST_WITH_COVARIANCE_STAMPED__STRUCT_HPP_
