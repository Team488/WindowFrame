...
void Accel__rosidl_typesupport_introspection_c__Accel_init_function(
...
void Accel__rosidl_typesupport_introspection_c__Accel_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers Accel__rosidl_typesupport_introspection_c__Accel_message_members = {
  ...
  Accel__rosidl_typesupport_introspection_c__Accel_init_function,  // function to initialize message memory (memory has to be allocated)
  Accel__rosidl_typesupport_introspection_c__Accel_fini_function  // function to terminate message instance (will not free memory)
};
