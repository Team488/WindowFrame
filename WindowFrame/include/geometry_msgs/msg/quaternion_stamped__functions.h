...
#ifndef GEOMETRY_MSGS__MSG__QUATERNION_STAMPED__FUNCTIONS_H_
#define GEOMETRY_MSGS__MSG__QUATERNION_STAMPED__FUNCTIONS_H_
...
#endif  // GEOMETRY_MSGS__MSG__QUATERNION_STAMPED__FUNCTIONS_H_
