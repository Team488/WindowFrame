...
struct AccelWithCovariance_
{
  ...
  explicit AccelWithCovariance_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : accel(_init)
  {
  ...
  explicit AccelWithCovariance_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : accel(_alloc, _init),
    covariance(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
