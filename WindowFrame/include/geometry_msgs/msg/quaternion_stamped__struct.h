...
#ifndef GEOMETRY_MSGS__MSG__QUATERNION_STAMPED__STRUCT_H_
#define GEOMETRY_MSGS__MSG__QUATERNION_STAMPED__STRUCT_H_
...
#endif  // GEOMETRY_MSGS__MSG__QUATERNION_STAMPED__STRUCT_H_
