...
void TwistWithCovariance__rosidl_typesupport_introspection_c__TwistWithCovariance_init_function(
...
void TwistWithCovariance__rosidl_typesupport_introspection_c__TwistWithCovariance_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers TwistWithCovariance__rosidl_typesupport_introspection_c__TwistWithCovariance_message_members = {
  ...
  TwistWithCovariance__rosidl_typesupport_introspection_c__TwistWithCovariance_init_function,  // function to initialize message memory (memory has to be allocated)
  TwistWithCovariance__rosidl_typesupport_introspection_c__TwistWithCovariance_fini_function  // function to terminate message instance (will not free memory)
};
