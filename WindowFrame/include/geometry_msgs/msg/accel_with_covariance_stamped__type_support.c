...
void AccelWithCovarianceStamped__rosidl_typesupport_introspection_c__AccelWithCovarianceStamped_init_function(
...
void AccelWithCovarianceStamped__rosidl_typesupport_introspection_c__AccelWithCovarianceStamped_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers AccelWithCovarianceStamped__rosidl_typesupport_introspection_c__AccelWithCovarianceStamped_message_members = {
  ...
  AccelWithCovarianceStamped__rosidl_typesupport_introspection_c__AccelWithCovarianceStamped_init_function,  // function to initialize message memory (memory has to be allocated)
  AccelWithCovarianceStamped__rosidl_typesupport_introspection_c__AccelWithCovarianceStamped_fini_function  // function to terminate message instance (will not free memory)
};
