...
void PolygonStamped__rosidl_typesupport_introspection_c__PolygonStamped_init_function(
...
void PolygonStamped__rosidl_typesupport_introspection_c__PolygonStamped_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers PolygonStamped__rosidl_typesupport_introspection_c__PolygonStamped_message_members = {
  ...
  PolygonStamped__rosidl_typesupport_introspection_c__PolygonStamped_init_function,  // function to initialize message memory (memory has to be allocated)
  PolygonStamped__rosidl_typesupport_introspection_c__PolygonStamped_fini_function  // function to terminate message instance (will not free memory)
};
