...
#ifndef GEOMETRY_MSGS__MSG__TRANSFORM_STAMPED__STRUCT_HPP_
#define GEOMETRY_MSGS__MSG__TRANSFORM_STAMPED__STRUCT_HPP_
...
struct TransformStamped_
{
  ...
  explicit TransformStamped_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    transform(_init)
  {
  ...
  explicit TransformStamped_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
...
#endif  // GEOMETRY_MSGS__MSG__TRANSFORM_STAMPED__STRUCT_HPP_
