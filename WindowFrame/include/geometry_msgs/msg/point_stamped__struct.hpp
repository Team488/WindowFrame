...
#ifndef GEOMETRY_MSGS__MSG__POINT_STAMPED__STRUCT_HPP_
#define GEOMETRY_MSGS__MSG__POINT_STAMPED__STRUCT_HPP_
...
struct PointStamped_
{
  ...
  explicit PointStamped_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    point(_init)
  {
    (void)_init;
  ...
  explicit PointStamped_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    point(_alloc, _init)
  {
    (void)_init;
...
#endif  // GEOMETRY_MSGS__MSG__POINT_STAMPED__STRUCT_HPP_
