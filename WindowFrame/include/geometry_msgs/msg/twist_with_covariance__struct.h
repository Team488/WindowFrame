...
#ifndef GEOMETRY_MSGS__MSG__TWIST_WITH_COVARIANCE__STRUCT_H_
#define GEOMETRY_MSGS__MSG__TWIST_WITH_COVARIANCE__STRUCT_H_
...
#endif  // GEOMETRY_MSGS__MSG__TWIST_WITH_COVARIANCE__STRUCT_H_
