...
void PointStamped__rosidl_typesupport_introspection_c__PointStamped_init_function(
...
void PointStamped__rosidl_typesupport_introspection_c__PointStamped_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers PointStamped__rosidl_typesupport_introspection_c__PointStamped_message_members = {
  ...
  PointStamped__rosidl_typesupport_introspection_c__PointStamped_init_function,  // function to initialize message memory (memory has to be allocated)
  PointStamped__rosidl_typesupport_introspection_c__PointStamped_fini_function  // function to terminate message instance (will not free memory)
};
