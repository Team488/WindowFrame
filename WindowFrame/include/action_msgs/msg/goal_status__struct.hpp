...
#ifndef ACTION_MSGS__MSG__GOAL_STATUS__STRUCT_HPP_
#define ACTION_MSGS__MSG__GOAL_STATUS__STRUCT_HPP_
...
struct GoalStatus_
{
  ...
  explicit GoalStatus_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : goal_info(_init)
  {
  ...
  explicit GoalStatus_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // ACTION_MSGS__MSG__GOAL_STATUS__STRUCT_HPP_
