...
#include <stddef.h>
#include "action_msgs/srv/cancel_goal__rosidl_typesupport_introspection_c.h"
#include "action_msgs/msg/rosidl_typesupport_introspection_c__visibility_control.h"
#include "rosidl_typesupport_introspection_c/field_types.h"
#include "rosidl_typesupport_introspection_c/identifier.h"
#include "rosidl_typesupport_introspection_c/message_introspection.h"
#include "action_msgs/srv/cancel_goal__functions.h"
#include "action_msgs/srv/cancel_goal__struct.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers action_msgs__srv__cancel_goal__rosidl_typesupport_introspection_c__CancelGoal_service_members = {
  "action_msgs__srv",  // service namespace
  "CancelGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // action_msgs__srv__cancel_goal__rosidl_typesupport_introspection_c__CancelGoal_Request_message_type_support_handle,
  NULL  // response message
  // action_msgs__srv__cancel_goal__rosidl_typesupport_introspection_c__CancelGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t action_msgs__srv__cancel_goal__rosidl_typesupport_introspection_c__CancelGoal_service_type_support_handle = {
  0,
  &action_msgs__srv__cancel_goal__rosidl_typesupport_introspection_c__CancelGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_msgs, srv, CancelGoal)() {
  if (!action_msgs__srv__cancel_goal__rosidl_typesupport_introspection_c__CancelGoal_service_type_support_handle.typesupport_identifier) {
    action_msgs__srv__cancel_goal__rosidl_typesupport_introspection_c__CancelGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)action_msgs__srv__cancel_goal__rosidl_typesupport_introspection_c__CancelGoal_service_type_support_handle.data;
  ...
  return &action_msgs__srv__cancel_goal__rosidl_typesupport_introspection_c__CancelGoal_service_type_support_handle;
}
