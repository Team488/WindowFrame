...
#include "nav_msgs/srv/get_map__functions.h"
#include "nav_msgs/srv/get_map__struct.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers nav_msgs__srv__get_map__rosidl_typesupport_introspection_c__GetMap_service_members = {
  "nav_msgs__srv",  // service namespace
  "GetMap",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // nav_msgs__srv__get_map__rosidl_typesupport_introspection_c__GetMap_Request_message_type_support_handle,
  NULL  // response message
  // nav_msgs__srv__get_map__rosidl_typesupport_introspection_c__GetMap_Response_message_type_support_handle
};

static rosidl_service_type_support_t nav_msgs__srv__get_map__rosidl_typesupport_introspection_c__GetMap_service_type_support_handle = {
  0,
  &nav_msgs__srv__get_map__rosidl_typesupport_introspection_c__GetMap_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_msgs, srv, GetMap)() {
  if (!nav_msgs__srv__get_map__rosidl_typesupport_introspection_c__GetMap_service_type_support_handle.typesupport_identifier) {
    nav_msgs__srv__get_map__rosidl_typesupport_introspection_c__GetMap_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)nav_msgs__srv__get_map__rosidl_typesupport_introspection_c__GetMap_service_type_support_handle.data;
  ...
  return &nav_msgs__srv__get_map__rosidl_typesupport_introspection_c__GetMap_service_type_support_handle;
}
