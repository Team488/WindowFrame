...
#ifndef NAV_MSGS__SRV__GET_MAP__ROSIDL_TYPESUPPORT_CONNEXT_CPP_HPP_
#define NAV_MSGS__SRV__GET_MAP__ROSIDL_TYPESUPPORT_CONNEXT_CPP_HPP_
...
#include "nav_msgs/srv/dds_connext/GetMap_Support.h"
#include "nav_msgs/srv/dds_connext/GetMap_Plugin.h"
...
DDS_TypeCode *
get_type_code__GetMap_Response();
...
bool
to_cdr_stream__GetMap_Response(
  const void * untyped_ros_message,
  ConnextStaticCDRStream * cdr_stream);

bool
to_message__GetMap_Response(
  const ConnextStaticCDRStream * cdr_stream,
  void * untyped_ros_message);
...
ROSIDL_TYPESUPPORT_CONNEXT_CPP_PUBLIC_nav_msgs
void *
get_request_datawriter__GetMap(void * untyped_requester);

ROSIDL_TYPESUPPORT_CONNEXT_CPP_PUBLIC_nav_msgs
void *
get_reply_datareader__GetMap(void * untyped_requester);

ROSIDL_TYPESUPPORT_CONNEXT_CPP_PUBLIC_nav_msgs
void *
get_request_datareader__GetMap(void * untyped_replier);

ROSIDL_TYPESUPPORT_CONNEXT_CPP_PUBLIC_nav_msgs
void *
get_reply_datawriter__GetMap(void * untyped_replier);
...
#endif  // NAV_MSGS__SRV__GET_MAP__ROSIDL_TYPESUPPORT_CONNEXT_CPP_HPP_
