...
#ifndef NAV_MSGS__SRV__GET_MAP__STRUCT_HPP_
#define NAV_MSGS__SRV__GET_MAP__STRUCT_HPP_
...
struct GetMap_Request_
{
  ...
  explicit GetMap_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GetMap_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
struct GetMap_Response_
{
  ...
  explicit GetMap_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : map(_init)
  {
    (void)_init;
  }

  explicit GetMap_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : map(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // NAV_MSGS__SRV__GET_MAP__STRUCT_HPP_
