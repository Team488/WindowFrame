...
#include "nav_msgs/srv/dds_connext/SetMap_Support.h"
#include "nav_msgs/srv/dds_connext/SetMap_Plugin.h"
...
bool
to_cdr_stream__SetMap_Request(
  const void * untyped_ros_message,
  ConnextStaticCDRStream * cdr_stream);

bool
to_message__SetMap_Request(
...
DDS_TypeCode *
get_type_code__SetMap_Response();
...
bool
to_cdr_stream__SetMap_Response(
  const void * untyped_ros_message,
  ConnextStaticCDRStream * cdr_stream);

bool
to_message__SetMap_Response(
  const ConnextStaticCDRStream * cdr_stream,
  void * untyped_ros_message);
