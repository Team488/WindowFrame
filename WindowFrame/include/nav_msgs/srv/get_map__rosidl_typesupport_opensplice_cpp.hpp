...
#ifndef NAV_MSGS__SRV__GET_MAP__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
#define NAV_MSGS__SRV__GET_MAP__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
// generated from
...
#include "nav_msgs/srv/dds_opensplice/ccpp_GetMap_.h"
...
const char *
serialize__GetMap_Request(
  const void * untyped_ros_message,
  void * serialized_data);

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_nav_msgs
const char *
deserialize__GetMap_Request(
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_nav_msgs
const char *
serialize__GetMap_Response(
  const void * untyped_ros_message,
  void * serialized_data);

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_nav_msgs
const char *
deserialize__GetMap_Response(
  const uint8_t * buffer,
  unsigned length,
  void * untyped_ros_message);
...
#endif
#endif  // NAV_MSGS__SRV__GET_MAP__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
