...
#ifndef NAV_MSGS__SRV__GET_PLAN__STRUCT_HPP_
#define NAV_MSGS__SRV__GET_PLAN__STRUCT_HPP_
...
struct GetPlan_Response_
{
  ...
  explicit GetPlan_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : plan(_init)
  {
    (void)_init;
  }

  explicit GetPlan_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : plan(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // NAV_MSGS__SRV__GET_PLAN__STRUCT_HPP_
