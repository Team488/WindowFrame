...
static rosidl_typesupport_introspection_c__ServiceMembers nav_msgs__srv__set_map__rosidl_typesupport_introspection_c__SetMap_service_members = {
  "nav_msgs__srv",  // service namespace
  "SetMap",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // nav_msgs__srv__set_map__rosidl_typesupport_introspection_c__SetMap_Request_message_type_support_handle,
  NULL  // response message
  // nav_msgs__srv__set_map__rosidl_typesupport_introspection_c__SetMap_Response_message_type_support_handle
};

static rosidl_service_type_support_t nav_msgs__srv__set_map__rosidl_typesupport_introspection_c__SetMap_service_type_support_handle = {
  0,
  &nav_msgs__srv__set_map__rosidl_typesupport_introspection_c__SetMap_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_msgs, srv, SetMap)() {
  if (!nav_msgs__srv__set_map__rosidl_typesupport_introspection_c__SetMap_service_type_support_handle.typesupport_identifier) {
    nav_msgs__srv__set_map__rosidl_typesupport_introspection_c__SetMap_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)nav_msgs__srv__set_map__rosidl_typesupport_introspection_c__SetMap_service_type_support_handle.data;
  ...
  return &nav_msgs__srv__set_map__rosidl_typesupport_introspection_c__SetMap_service_type_support_handle;
}
