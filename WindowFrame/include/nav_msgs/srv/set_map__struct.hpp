...
#ifndef NAV_MSGS__SRV__SET_MAP__STRUCT_HPP_
#define NAV_MSGS__SRV__SET_MAP__STRUCT_HPP_
...
struct SetMap_Request_
{
  ...
  explicit SetMap_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : map(_init),
    initial_pose(_init)
  {
    (void)_init;
  ...
  explicit SetMap_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : map(_alloc, _init),
...
struct SetMap_Response_
{
  ...
  explicit SetMap_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit SetMap_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // NAV_MSGS__SRV__SET_MAP__STRUCT_HPP_
