...
#ifndef NAV_MSGS__MSG__MAP_META_DATA__STRUCT_HPP_
#define NAV_MSGS__MSG__MAP_META_DATA__STRUCT_HPP_
...
struct MapMetaData_
{
  ...
  explicit MapMetaData_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : map_load_time(_init),
    origin(_init)
  {
  ...
  explicit MapMetaData_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // NAV_MSGS__MSG__MAP_META_DATA__STRUCT_HPP_
