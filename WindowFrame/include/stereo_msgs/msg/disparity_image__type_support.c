...
static const rosidl_typesupport_introspection_c__MessageMembers DisparityImage__rosidl_typesupport_introspection_c__DisparityImage_message_members = {
...
static rosidl_message_type_support_t DisparityImage__rosidl_typesupport_introspection_c__DisparityImage_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, stereo_msgs, msg, DisparityImage)() {
  DisparityImage__rosidl_typesupport_introspection_c__DisparityImage_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  DisparityImage__rosidl_typesupport_introspection_c__DisparityImage_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, msg, Image)();
  DisparityImage__rosidl_typesupport_introspection_c__DisparityImage_message_member_array[4].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, msg, RegionOfInterest)();
  if (!DisparityImage__rosidl_typesupport_introspection_c__DisparityImage_message_type_support_handle.typesupport_identifier) {
    DisparityImage__rosidl_typesupport_introspection_c__DisparityImage_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &DisparityImage__rosidl_typesupport_introspection_c__DisparityImage_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
