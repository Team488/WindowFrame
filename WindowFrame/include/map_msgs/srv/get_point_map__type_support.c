...
#include <stddef.h>
#include "map_msgs/srv/get_point_map__rosidl_typesupport_introspection_c.h"
#include "map_msgs/msg/rosidl_typesupport_introspection_c__visibility_control.h"
#include "rosidl_typesupport_introspection_c/field_types.h"
#include "rosidl_typesupport_introspection_c/identifier.h"
#include "rosidl_typesupport_introspection_c/message_introspection.h"
#include "map_msgs/srv/get_point_map__functions.h"
#include "map_msgs/srv/get_point_map__struct.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers map_msgs__srv__get_point_map__rosidl_typesupport_introspection_c__GetPointMap_service_members = {
  "map_msgs__srv",  // service namespace
  "GetPointMap",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // map_msgs__srv__get_point_map__rosidl_typesupport_introspection_c__GetPointMap_Request_message_type_support_handle,
  NULL  // response message
  // map_msgs__srv__get_point_map__rosidl_typesupport_introspection_c__GetPointMap_Response_message_type_support_handle
};

static rosidl_service_type_support_t map_msgs__srv__get_point_map__rosidl_typesupport_introspection_c__GetPointMap_service_type_support_handle = {
  0,
  &map_msgs__srv__get_point_map__rosidl_typesupport_introspection_c__GetPointMap_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, map_msgs, srv, GetPointMap)() {
  if (!map_msgs__srv__get_point_map__rosidl_typesupport_introspection_c__GetPointMap_service_type_support_handle.typesupport_identifier) {
    map_msgs__srv__get_point_map__rosidl_typesupport_introspection_c__GetPointMap_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)map_msgs__srv__get_point_map__rosidl_typesupport_introspection_c__GetPointMap_service_type_support_handle.data;
  ...
  return &map_msgs__srv__get_point_map__rosidl_typesupport_introspection_c__GetPointMap_service_type_support_handle;
}
