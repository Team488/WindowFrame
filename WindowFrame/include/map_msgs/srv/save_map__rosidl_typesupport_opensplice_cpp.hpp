...
#ifndef MAP_MSGS__SRV__SAVE_MAP__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
#define MAP_MSGS__SRV__SAVE_MAP__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
// generated from
...
#include "map_msgs/srv/dds_opensplice/ccpp_SaveMap_.h"
...
extern void register_type__SaveMap_Request(
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_map_msgs
extern void publish__SaveMap_Request(
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_map_msgs
extern bool take__SaveMap_Request(
...
const char *
serialize__SaveMap_Request(
  const void * untyped_ros_message,
  void * serialized_data);

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_map_msgs
const char *
deserialize__SaveMap_Request(
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_map_msgs
const char *
serialize__SaveMap_Response(
  const void * untyped_ros_message,
  void * serialized_data);

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_map_msgs
const char *
deserialize__SaveMap_Response(
  const uint8_t * buffer,
  unsigned length,
  void * untyped_ros_message);
...
#endif
#endif  // MAP_MSGS__SRV__SAVE_MAP__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
