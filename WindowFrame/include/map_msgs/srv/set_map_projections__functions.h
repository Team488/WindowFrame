...
#ifndef MAP_MSGS__SRV__SET_MAP_PROJECTIONS__FUNCTIONS_H_
#define MAP_MSGS__SRV__SET_MAP_PROJECTIONS__FUNCTIONS_H_
...
#endif  // MAP_MSGS__SRV__SET_MAP_PROJECTIONS__FUNCTIONS_H_
