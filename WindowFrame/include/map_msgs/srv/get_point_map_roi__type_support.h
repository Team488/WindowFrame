...
#ifndef MAP_MSGS__SRV__GET_POINT_MAP_ROI__TYPE_SUPPORT_H_
#define MAP_MSGS__SRV__GET_POINT_MAP_ROI__TYPE_SUPPORT_H_
...
#endif  // MAP_MSGS__SRV__GET_POINT_MAP_ROI__TYPE_SUPPORT_H_
