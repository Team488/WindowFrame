...
#include "map_msgs/srv/dds_connext/GetPointMapROI_Support.h"
#include "map_msgs/srv/dds_connext/GetPointMapROI_Plugin.h"
...
DDS_TypeCode *
get_type_code__GetPointMapROI_Request();
...
bool
to_cdr_stream__GetPointMapROI_Request(
  const void * untyped_ros_message,
  ConnextStaticCDRStream * cdr_stream);

bool
to_message__GetPointMapROI_Request(
...
DDS_TypeCode *
get_type_code__GetPointMapROI_Response();
...
bool
to_cdr_stream__GetPointMapROI_Response(
  const void * untyped_ros_message,
  ConnextStaticCDRStream * cdr_stream);

bool
to_message__GetPointMapROI_Response(
  const ConnextStaticCDRStream * cdr_stream,
  void * untyped_ros_message);
