...
#include "map_msgs/srv/dds_connext/SaveMap_Support.h"
#include "map_msgs/srv/dds_connext/SaveMap_Plugin.h"
...
DDS_TypeCode *
get_type_code__SaveMap_Response();
...
bool
to_cdr_stream__SaveMap_Response(
  const void * untyped_ros_message,
  ConnextStaticCDRStream * cdr_stream);

bool
to_message__SaveMap_Response(
  const ConnextStaticCDRStream * cdr_stream,
  void * untyped_ros_message);
