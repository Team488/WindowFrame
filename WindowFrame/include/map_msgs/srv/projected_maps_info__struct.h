...
#ifndef MAP_MSGS__SRV__PROJECTED_MAPS_INFO__STRUCT_H_
#define MAP_MSGS__SRV__PROJECTED_MAPS_INFO__STRUCT_H_
...
#endif  // MAP_MSGS__SRV__PROJECTED_MAPS_INFO__STRUCT_H_
