...
#ifndef MAP_MSGS__SRV__PROJECTED_MAPS_INFO__TYPE_SUPPORT_H_
#define MAP_MSGS__SRV__PROJECTED_MAPS_INFO__TYPE_SUPPORT_H_
...
#endif  // MAP_MSGS__SRV__PROJECTED_MAPS_INFO__TYPE_SUPPORT_H_
