...
#ifndef MAP_MSGS__MSG__OCCUPANCY_GRID_UPDATE__STRUCT_HPP_
#define MAP_MSGS__MSG__OCCUPANCY_GRID_UPDATE__STRUCT_HPP_
...
struct OccupancyGridUpdate_
{
  ...
  explicit OccupancyGridUpdate_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
  ...
  explicit OccupancyGridUpdate_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // MAP_MSGS__MSG__OCCUPANCY_GRID_UPDATE__STRUCT_HPP_
