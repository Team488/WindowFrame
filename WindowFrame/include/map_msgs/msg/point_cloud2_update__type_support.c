...
#include "map_msgs/msg/point_cloud2_update__functions.h"
...
void PointCloud2Update__rosidl_typesupport_introspection_c__PointCloud2Update_init_function(
...
void PointCloud2Update__rosidl_typesupport_introspection_c__PointCloud2Update_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers PointCloud2Update__rosidl_typesupport_introspection_c__PointCloud2Update_message_members = {
  ...
  PointCloud2Update__rosidl_typesupport_introspection_c__PointCloud2Update_init_function,  // function to initialize message memory (memory has to be allocated)
  PointCloud2Update__rosidl_typesupport_introspection_c__PointCloud2Update_fini_function  // function to terminate message instance (will not free memory)
};
