...
#ifndef MAP_MSGS__MSG__POINT_CLOUD2_UPDATE__STRUCT_HPP_
#define MAP_MSGS__MSG__POINT_CLOUD2_UPDATE__STRUCT_HPP_
...
struct PointCloud2Update_
{
  ...
  explicit PointCloud2Update_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    points(_init)
  {
  ...
  explicit PointCloud2Update_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    points(_alloc, _init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
#endif  // MAP_MSGS__MSG__POINT_CLOUD2_UPDATE__STRUCT_HPP_
