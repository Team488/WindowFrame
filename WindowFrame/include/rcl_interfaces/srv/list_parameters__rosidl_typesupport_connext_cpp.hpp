...
#ifndef RCL_INTERFACES__SRV__LIST_PARAMETERS__ROSIDL_TYPESUPPORT_CONNEXT_CPP_HPP_
#define RCL_INTERFACES__SRV__LIST_PARAMETERS__ROSIDL_TYPESUPPORT_CONNEXT_CPP_HPP_
...
#include "rcl_interfaces/srv/dds_connext/ListParameters_Support.h"
#include "rcl_interfaces/srv/dds_connext/ListParameters_Plugin.h"
...
DDS_TypeCode *
get_type_code__ListParameters_Request();
...
bool
to_cdr_stream__ListParameters_Request(
  const void * untyped_ros_message,
  ConnextStaticCDRStream * cdr_stream);

bool
to_message__ListParameters_Request(
...
ROSIDL_TYPESUPPORT_CONNEXT_CPP_PUBLIC_rcl_interfaces
void *
create_replier__ListParameters(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
...
ROSIDL_TYPESUPPORT_CONNEXT_CPP_PUBLIC_rcl_interfaces
const char *
destroy_replier__ListParameters(
...
ROSIDL_TYPESUPPORT_CONNEXT_CPP_PUBLIC_rcl_interfaces
void *
get_request_datawriter__ListParameters(void * untyped_requester);

ROSIDL_TYPESUPPORT_CONNEXT_CPP_PUBLIC_rcl_interfaces
void *
get_reply_datareader__ListParameters(void * untyped_requester);

ROSIDL_TYPESUPPORT_CONNEXT_CPP_PUBLIC_rcl_interfaces
void *
get_request_datareader__ListParameters(void * untyped_replier);

ROSIDL_TYPESUPPORT_CONNEXT_CPP_PUBLIC_rcl_interfaces
void *
get_reply_datawriter__ListParameters(void * untyped_replier);
...
#endif  // RCL_INTERFACES__SRV__LIST_PARAMETERS__ROSIDL_TYPESUPPORT_CONNEXT_CPP_HPP_
