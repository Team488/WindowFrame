...
#ifndef RCL_INTERFACES__SRV__DESCRIBE_PARAMETERS__STRUCT_H_
#define RCL_INTERFACES__SRV__DESCRIBE_PARAMETERS__STRUCT_H_
...
#endif  // RCL_INTERFACES__SRV__DESCRIBE_PARAMETERS__STRUCT_H_
