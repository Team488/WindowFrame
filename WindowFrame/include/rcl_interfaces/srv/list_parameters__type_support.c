...
#include "rcl_interfaces/srv/list_parameters__functions.h"
#include "rcl_interfaces/srv/list_parameters__struct.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers rcl_interfaces__srv__list_parameters__rosidl_typesupport_introspection_c__ListParameters_service_members = {
  "rcl_interfaces__srv",  // service namespace
  "ListParameters",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // rcl_interfaces__srv__list_parameters__rosidl_typesupport_introspection_c__ListParameters_Request_message_type_support_handle,
  NULL  // response message
  // rcl_interfaces__srv__list_parameters__rosidl_typesupport_introspection_c__ListParameters_Response_message_type_support_handle
};

static rosidl_service_type_support_t rcl_interfaces__srv__list_parameters__rosidl_typesupport_introspection_c__ListParameters_service_type_support_handle = {
  0,
  &rcl_interfaces__srv__list_parameters__rosidl_typesupport_introspection_c__ListParameters_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, srv, ListParameters)() {
  if (!rcl_interfaces__srv__list_parameters__rosidl_typesupport_introspection_c__ListParameters_service_type_support_handle.typesupport_identifier) {
    rcl_interfaces__srv__list_parameters__rosidl_typesupport_introspection_c__ListParameters_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)rcl_interfaces__srv__list_parameters__rosidl_typesupport_introspection_c__ListParameters_service_type_support_handle.data;
  ...
  return &rcl_interfaces__srv__list_parameters__rosidl_typesupport_introspection_c__ListParameters_service_type_support_handle;
}
