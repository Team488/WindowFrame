...
#ifndef RCL_INTERFACES__SRV__SET_PARAMETERS_ATOMICALLY__STRUCT_H_
#define RCL_INTERFACES__SRV__SET_PARAMETERS_ATOMICALLY__STRUCT_H_
...
#endif  // RCL_INTERFACES__SRV__SET_PARAMETERS_ATOMICALLY__STRUCT_H_
