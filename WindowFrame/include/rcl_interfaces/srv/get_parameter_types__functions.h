...
#ifndef RCL_INTERFACES__SRV__GET_PARAMETER_TYPES__FUNCTIONS_H_
#define RCL_INTERFACES__SRV__GET_PARAMETER_TYPES__FUNCTIONS_H_
...
#endif  // RCL_INTERFACES__SRV__GET_PARAMETER_TYPES__FUNCTIONS_H_
