...
#ifndef RCL_INTERFACES__SRV__DESCRIBE_PARAMETERS__FUNCTIONS_H_
#define RCL_INTERFACES__SRV__DESCRIBE_PARAMETERS__FUNCTIONS_H_
...
#endif  // RCL_INTERFACES__SRV__DESCRIBE_PARAMETERS__FUNCTIONS_H_
