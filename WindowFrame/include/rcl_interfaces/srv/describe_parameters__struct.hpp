...
#ifndef RCL_INTERFACES__SRV__DESCRIBE_PARAMETERS__STRUCT_HPP_
#define RCL_INTERFACES__SRV__DESCRIBE_PARAMETERS__STRUCT_HPP_
...
struct DescribeParameters_Request_
{
  ...
  explicit DescribeParameters_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit DescribeParameters_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
struct DescribeParameters_Response_
{
  ...
  explicit DescribeParameters_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit DescribeParameters_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
#endif  // RCL_INTERFACES__SRV__DESCRIBE_PARAMETERS__STRUCT_HPP_
