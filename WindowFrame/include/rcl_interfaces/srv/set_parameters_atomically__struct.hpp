...
#ifndef RCL_INTERFACES__SRV__SET_PARAMETERS_ATOMICALLY__STRUCT_HPP_
#define RCL_INTERFACES__SRV__SET_PARAMETERS_ATOMICALLY__STRUCT_HPP_
...
struct SetParametersAtomically_Request_
{
  ...
  explicit SetParametersAtomically_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit SetParametersAtomically_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
struct SetParametersAtomically_Response_
{
  ...
  explicit SetParametersAtomically_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : result(_init)
  {
    (void)_init;
  }

  explicit SetParametersAtomically_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : result(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // RCL_INTERFACES__SRV__SET_PARAMETERS_ATOMICALLY__STRUCT_HPP_
