...
#ifndef RCL_INTERFACES__SRV__LIST_PARAMETERS__STRUCT_HPP_
#define RCL_INTERFACES__SRV__LIST_PARAMETERS__STRUCT_HPP_
...
struct ListParameters_Response_
{
  ...
  explicit ListParameters_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : result(_init)
  {
    (void)_init;
  }

  explicit ListParameters_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : result(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // RCL_INTERFACES__SRV__LIST_PARAMETERS__STRUCT_HPP_
