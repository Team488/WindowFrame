...
#ifndef RCL_INTERFACES__SRV__GET_PARAMETER_TYPES__STRUCT_HPP_
#define RCL_INTERFACES__SRV__GET_PARAMETER_TYPES__STRUCT_HPP_
...
struct GetParameterTypes_Request_
{
  ...
  explicit GetParameterTypes_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit GetParameterTypes_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
struct GetParameterTypes_Response_
{
  ...
  explicit GetParameterTypes_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit GetParameterTypes_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
#endif  // RCL_INTERFACES__SRV__GET_PARAMETER_TYPES__STRUCT_HPP_
