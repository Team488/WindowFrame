#ifndef H_ED8B057A57C92E411125C7AE50570277_GetParameterTypes_SPLTYPES_H
#define H_ED8B057A57C92E411125C7AE50570277_GetParameterTypes_SPLTYPES_H
...
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_rcl_interfaces v_copyin_result __rcl_interfaces_srv_dds__Sample_GetParameterTypes_Request___copyIn(c_base base, const struct rcl_interfaces::srv::dds_::Sample_GetParameterTypes_Request_ *from, struct _rcl_interfaces_srv_dds__Sample_GetParameterTypes_Request_ *to);
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_rcl_interfaces void __rcl_interfaces_srv_dds__Sample_GetParameterTypes_Request___copyOut(const void *_from, void *_to);
struct _rcl_interfaces_srv_dds__Sample_GetParameterTypes_Request_ {
...
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_rcl_interfaces v_copyin_result __rcl_interfaces_srv_dds__Sample_GetParameterTypes_Response___copyIn(c_base base, const struct rcl_interfaces::srv::dds_::Sample_GetParameterTypes_Response_ *from, struct _rcl_interfaces_srv_dds__Sample_GetParameterTypes_Response_ *to);
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_rcl_interfaces void __rcl_interfaces_srv_dds__Sample_GetParameterTypes_Response___copyOut(const void *_from, void *_to);
struct _rcl_interfaces_srv_dds__Sample_GetParameterTypes_Response_ {
    c_ulonglong client_guid_0_;
    c_ulonglong client_guid_1_;
    c_longlong sequence_number_;
