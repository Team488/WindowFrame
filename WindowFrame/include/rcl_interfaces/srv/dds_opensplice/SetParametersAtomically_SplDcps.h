#ifndef H_F081AFF700037897B9B7AD2C7D83D9DB_SetParametersAtomically_SPLTYPES_H
#define H_F081AFF700037897B9B7AD2C7D83D9DB_SetParametersAtomically_SPLTYPES_H
...
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_rcl_interfaces v_copyin_result __rcl_interfaces_srv_dds__Sample_SetParametersAtomically_Response___copyIn(c_base base, const struct rcl_interfaces::srv::dds_::Sample_SetParametersAtomically_Response_ *from, struct _rcl_interfaces_srv_dds__Sample_SetParametersAtomically_Response_ *to);
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_rcl_interfaces void __rcl_interfaces_srv_dds__Sample_SetParametersAtomically_Response___copyOut(const void *_from, void *_to);
struct _rcl_interfaces_srv_dds__Sample_SetParametersAtomically_Response_ {
    c_ulonglong client_guid_0_;
    c_ulonglong client_guid_1_;
    c_longlong sequence_number_;
