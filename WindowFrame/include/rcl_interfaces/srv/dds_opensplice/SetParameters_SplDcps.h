#ifndef H_DA076F1C98F6CA67B63BB61A362B8A5D_SetParameters_SPLTYPES_H
#define H_DA076F1C98F6CA67B63BB61A362B8A5D_SetParameters_SPLTYPES_H
...
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_rcl_interfaces v_copyin_result __rcl_interfaces_srv_dds__Sample_SetParameters_Response___copyIn(c_base base, const struct rcl_interfaces::srv::dds_::Sample_SetParameters_Response_ *from, struct _rcl_interfaces_srv_dds__Sample_SetParameters_Response_ *to);
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_rcl_interfaces void __rcl_interfaces_srv_dds__Sample_SetParameters_Response___copyOut(const void *_from, void *_to);
struct _rcl_interfaces_srv_dds__Sample_SetParameters_Response_ {
    c_ulonglong client_guid_0_;
    c_ulonglong client_guid_1_;
    c_longlong sequence_number_;
