#ifndef H_8E31CB347BB13ECAEFE0963DCDCA103B_GetParameters_SPLTYPES_H
#define H_8E31CB347BB13ECAEFE0963DCDCA103B_GetParameters_SPLTYPES_H
...
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_rcl_interfaces v_copyin_result __rcl_interfaces_srv_dds__GetParameters_Request___copyIn(c_base base, const struct rcl_interfaces::srv::dds_::GetParameters_Request_ *from, struct _rcl_interfaces_srv_dds__GetParameters_Request_ *to);
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_rcl_interfaces void __rcl_interfaces_srv_dds__GetParameters_Request___copyOut(const void *_from, void *_to);
struct _rcl_interfaces_srv_dds__GetParameters_Request_ {
    c_sequence names_;
};
...
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_rcl_interfaces v_copyin_result __rcl_interfaces_srv_dds__Sample_GetParameters_Request___copyIn(c_base base, const struct rcl_interfaces::srv::dds_::Sample_GetParameters_Request_ *from, struct _rcl_interfaces_srv_dds__Sample_GetParameters_Request_ *to);
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_rcl_interfaces void __rcl_interfaces_srv_dds__Sample_GetParameters_Request___copyOut(const void *_from, void *_to);
struct _rcl_interfaces_srv_dds__Sample_GetParameters_Request_ {
