#ifndef _H_719FAB918C48D65DEF752289B0B3A014_ParameterDescriptor_DCPS_H_
#define _H_719FAB918C48D65DEF752289B0B3A014_ParameterDescriptor_DCPS_H_
...
namespace rcl_interfaces
{
    namespace msg
    {
        namespace dds_
        {
            ...
            class ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_rcl_interfaces ParameterDescriptor_TypeSupportInterface :
            ...
            class ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_rcl_interfaces ParameterDescriptor_DataWriter :
            ...
            class ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_rcl_interfaces ParameterDescriptor_DataReader :
            ...
            class ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_rcl_interfaces ParameterDescriptor_DataReaderView :
