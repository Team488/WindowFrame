...
#include <stddef.h>
#include "rcl_interfaces/msg/log__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Log__rosidl_typesupport_introspection_c__Log_message_member_array[7] = {
  {
    "stamp",  // name
