...
void ListParametersResult__rosidl_typesupport_introspection_c__ListParametersResult_init_function(
...
void ListParametersResult__rosidl_typesupport_introspection_c__ListParametersResult_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers ListParametersResult__rosidl_typesupport_introspection_c__ListParametersResult_message_members = {
  ...
  ListParametersResult__rosidl_typesupport_introspection_c__ListParametersResult_init_function,  // function to initialize message memory (memory has to be allocated)
  ListParametersResult__rosidl_typesupport_introspection_c__ListParametersResult_fini_function  // function to terminate message instance (will not free memory)
};
