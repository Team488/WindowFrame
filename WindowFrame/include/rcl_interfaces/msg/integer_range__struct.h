...
#ifndef RCL_INTERFACES__MSG__INTEGER_RANGE__STRUCT_H_
#define RCL_INTERFACES__MSG__INTEGER_RANGE__STRUCT_H_
...
#endif  // RCL_INTERFACES__MSG__INTEGER_RANGE__STRUCT_H_
