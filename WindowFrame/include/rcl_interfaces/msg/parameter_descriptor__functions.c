...
#include "rcl_interfaces/msg/floating_point_range__functions.h"
// Member `integer_range`
#include "rcl_interfaces/msg/integer_range__functions.h"
...
rcl_interfaces__msg__ParameterDescriptor__init(rcl_interfaces__msg__ParameterDescriptor * msg)
{
  ...
  if (!rosidl_generator_c__String__init(&msg->additional_constraints)) {
    rcl_interfaces__msg__ParameterDescriptor__destroy(msg);
    return false;
  }
  // read_only
...
rcl_interfaces__msg__ParameterDescriptor__fini(rcl_interfaces__msg__ParameterDescriptor * msg)
{
  ...
  // additional_constraints
  rosidl_generator_c__String__fini(&msg->additional_constraints);
  // read_only
  // floating_point_range
