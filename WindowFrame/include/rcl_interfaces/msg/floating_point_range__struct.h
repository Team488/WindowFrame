...
#ifndef RCL_INTERFACES__MSG__FLOATING_POINT_RANGE__STRUCT_H_
#define RCL_INTERFACES__MSG__FLOATING_POINT_RANGE__STRUCT_H_
...
#endif  // RCL_INTERFACES__MSG__FLOATING_POINT_RANGE__STRUCT_H_
