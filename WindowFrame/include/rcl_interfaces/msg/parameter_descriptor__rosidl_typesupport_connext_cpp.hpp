...
#ifndef RCL_INTERFACES__MSG__PARAMETER_DESCRIPTOR__ROSIDL_TYPESUPPORT_CONNEXT_CPP_HPP_
#define RCL_INTERFACES__MSG__PARAMETER_DESCRIPTOR__ROSIDL_TYPESUPPORT_CONNEXT_CPP_HPP_
...
#include "rcl_interfaces/msg/dds_connext/ParameterDescriptor_Support.h"
...
DDS_TypeCode *
get_type_code__ParameterDescriptor();
...
bool
to_cdr_stream__ParameterDescriptor(
  const void * untyped_ros_message,
  ConnextStaticCDRStream * cdr_stream);

bool
to_message__ParameterDescriptor(
...
#endif  // RCL_INTERFACES__MSG__PARAMETER_DESCRIPTOR__ROSIDL_TYPESUPPORT_CONNEXT_CPP_HPP_
