...
rcl_interfaces__msg__ParameterValue__init(rcl_interfaces__msg__ParameterValue * msg)
{
  ...
  // byte_array_value
  if (!rosidl_generator_c__octet__Sequence__init(&msg->byte_array_value, 0)) {
    rcl_interfaces__msg__ParameterValue__destroy(msg);
    return false;
  }
  // bool_array_value
  if (!rosidl_generator_c__boolean__Sequence__init(&msg->bool_array_value, 0)) {
    rcl_interfaces__msg__ParameterValue__destroy(msg);
    return false;
  }
  // integer_array_value
  if (!rosidl_generator_c__int64__Sequence__init(&msg->integer_array_value, 0)) {
    rcl_interfaces__msg__ParameterValue__destroy(msg);
    return false;
  }
  // double_array_value
  if (!rosidl_generator_c__double__Sequence__init(&msg->double_array_value, 0)) {
    rcl_interfaces__msg__ParameterValue__destroy(msg);
    return false;
  }
  // string_array_value
  if (!rosidl_generator_c__String__Sequence__init(&msg->string_array_value, 0)) {
    rcl_interfaces__msg__ParameterValue__destroy(msg);
    return false;
  }
  return true;
...
rcl_interfaces__msg__ParameterValue__fini(rcl_interfaces__msg__ParameterValue * msg)
{
  ...
  // byte_array_value
  rosidl_generator_c__octet__Sequence__fini(&msg->byte_array_value);
  // bool_array_value
  rosidl_generator_c__boolean__Sequence__fini(&msg->bool_array_value);
  // integer_array_value
  rosidl_generator_c__int64__Sequence__fini(&msg->integer_array_value);
  // double_array_value
  rosidl_generator_c__double__Sequence__fini(&msg->double_array_value);
  // string_array_value
  rosidl_generator_c__String__Sequence__fini(&msg->string_array_value);
}
