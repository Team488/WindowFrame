...
#include "rcl_interfaces/msg/log__functions.h"
...
rcl_interfaces__msg__Log__init(rcl_interfaces__msg__Log * msg)
{
  ...
  // msg
  if (!rosidl_generator_c__String__init(&msg->msg)) {
    rcl_interfaces__msg__Log__destroy(msg);
    return false;
  }
  // file
  if (!rosidl_generator_c__String__init(&msg->file)) {
    rcl_interfaces__msg__Log__destroy(msg);
    return false;
  }
  // function
  if (!rosidl_generator_c__String__init(&msg->function)) {
    rcl_interfaces__msg__Log__destroy(msg);
    return false;
  }
  // line
...
rcl_interfaces__msg__Log__fini(rcl_interfaces__msg__Log * msg)
{
  ...
  // msg
  rosidl_generator_c__String__fini(&msg->msg);
  // file
  rosidl_generator_c__String__fini(&msg->file);
  // function
  rosidl_generator_c__String__fini(&msg->function);
  // line
}
