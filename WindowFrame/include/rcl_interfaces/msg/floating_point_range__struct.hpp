...
#ifndef RCL_INTERFACES__MSG__FLOATING_POINT_RANGE__STRUCT_HPP_
#define RCL_INTERFACES__MSG__FLOATING_POINT_RANGE__STRUCT_HPP_
...
struct FloatingPointRange_
{
  ...
  explicit FloatingPointRange_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit FloatingPointRange_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // RCL_INTERFACES__MSG__FLOATING_POINT_RANGE__STRUCT_HPP_
