...
#ifndef RCL_INTERFACES__MSG__INTEGER_RANGE__STRUCT_HPP_
#define RCL_INTERFACES__MSG__INTEGER_RANGE__STRUCT_HPP_
...
struct IntegerRange_
{
  ...
  explicit IntegerRange_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit IntegerRange_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // RCL_INTERFACES__MSG__INTEGER_RANGE__STRUCT_HPP_
