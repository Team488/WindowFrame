...
typedef struct rcl_interfaces__msg__ParameterValue
{
  ...
  rosidl_generator_c__octet__Sequence byte_array_value;
  rosidl_generator_c__boolean__Sequence bool_array_value;
  rosidl_generator_c__int64__Sequence integer_array_value;
  rosidl_generator_c__double__Sequence double_array_value;
