...
struct ParameterEvent_
{
  ...
  explicit ParameterEvent_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : stamp(_init)
  {
  ...
  explicit ParameterEvent_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : stamp(_alloc, _init),
    node(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
