...
#ifndef SHAPE_MSGS__MSG__MESH_TRIANGLE__FUNCTIONS_H_
#define SHAPE_MSGS__MSG__MESH_TRIANGLE__FUNCTIONS_H_
...
#endif  // SHAPE_MSGS__MSG__MESH_TRIANGLE__FUNCTIONS_H_
