...
#ifndef UNIQUE_IDENTIFIER_MSGS__MSG__UUID__STRUCT_HPP_
#define UNIQUE_IDENTIFIER_MSGS__MSG__UUID__STRUCT_HPP_
...
struct UUID_
{
  ...
  explicit UUID_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit UUID_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : uuid(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // UNIQUE_IDENTIFIER_MSGS__MSG__UUID__STRUCT_HPP_
