...
#ifndef UNIQUE_IDENTIFIER_MSGS__MSG__UUID__TYPE_SUPPORT_H_
#define UNIQUE_IDENTIFIER_MSGS__MSG__UUID__TYPE_SUPPORT_H_
...
#endif  // UNIQUE_IDENTIFIER_MSGS__MSG__UUID__TYPE_SUPPORT_H_
