...
#ifndef UNIQUE_IDENTIFIER_MSGS__MSG__UUID__FUNCTIONS_H_
#define UNIQUE_IDENTIFIER_MSGS__MSG__UUID__FUNCTIONS_H_
...
#endif  // UNIQUE_IDENTIFIER_MSGS__MSG__UUID__FUNCTIONS_H_
