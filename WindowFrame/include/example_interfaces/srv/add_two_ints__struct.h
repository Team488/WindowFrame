...
#ifndef EXAMPLE_INTERFACES__SRV__ADD_TWO_INTS__STRUCT_H_
#define EXAMPLE_INTERFACES__SRV__ADD_TWO_INTS__STRUCT_H_
...
#endif  // EXAMPLE_INTERFACES__SRV__ADD_TWO_INTS__STRUCT_H_
