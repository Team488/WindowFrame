...
#ifndef EXAMPLE_INTERFACES__ACTION__FIBONACCI__TYPE_SUPPORT_H_
#define EXAMPLE_INTERFACES__ACTION__FIBONACCI__TYPE_SUPPORT_H_
...
#endif  // EXAMPLE_INTERFACES__ACTION__FIBONACCI__TYPE_SUPPORT_H_
