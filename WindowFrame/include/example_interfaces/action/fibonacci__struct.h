...
#ifndef EXAMPLE_INTERFACES__ACTION__FIBONACCI__STRUCT_H_
#define EXAMPLE_INTERFACES__ACTION__FIBONACCI__STRUCT_H_
...
#endif  // EXAMPLE_INTERFACES__ACTION__FIBONACCI__STRUCT_H_
