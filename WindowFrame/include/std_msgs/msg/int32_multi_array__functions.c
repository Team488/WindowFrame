...
std_msgs__msg__Int32MultiArray__init(std_msgs__msg__Int32MultiArray * msg)
{
  ...
  if (!std_msgs__msg__MultiArrayLayout__init(&msg->layout)) {
    std_msgs__msg__Int32MultiArray__destroy(msg);
    return false;
  }
  // data
...
{
  std_msgs__msg__Int32MultiArray__Sequence * array = (std_msgs__msg__Int32MultiArray__Sequence *)malloc(sizeof(std_msgs__msg__Int32MultiArray__Sequence));
  if (!array) {
    return NULL;
  }
