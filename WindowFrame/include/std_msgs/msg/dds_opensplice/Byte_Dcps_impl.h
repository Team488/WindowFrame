#ifndef H_3AC67B988A93DD9E8B1DEACFE8C2F428_Byte_DCPS_IMPL_H_
#define H_3AC67B988A93DD9E8B1DEACFE8C2F428_Byte_DCPS_IMPL_H_
...
namespace std_msgs {
    ...
    namespace msg {
        ...
        namespace dds_ {
            ...
            class ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_std_msgs Byte_TypeSupportMetaHolder : public ::DDS::OpenSplice::TypeSupportMetaHolder
            {
            public:
                Byte_TypeSupportMetaHolder ();
                virtual ~Byte_TypeSupportMetaHolder ();
            ...
            class ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_std_msgs Byte_TypeSupport : public virtual Byte_TypeSupportInterface,
                                                               public ::DDS::OpenSplice::TypeSupport
            {
            public:
                Byte_TypeSupport ();
            
                virtual ~Byte_TypeSupport ();
            
            private:
                Byte_TypeSupport (const Byte_TypeSupport &);
            
                Byte_TypeSupport & operator= (const Byte_TypeSupport &);
            };
            
            typedef Byte_TypeSupportInterface_var Byte_TypeSupport_var;
            typedef Byte_TypeSupportInterface_ptr Byte_TypeSupport_ptr;
            
            class ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_std_msgs Byte_DataWriter_impl : public virtual Byte_DataWriter,
                                                                   public ::DDS::OpenSplice::FooDataWriter_impl
            {
                friend class DDS::OpenSplice::Publisher;
                friend class Byte_TypeSupportMetaHolder;
            ...
            private:
                ...
                Byte_DataWriter_impl & operator= (const Byte_DataWriter_impl &);
            };
            
            class ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_std_msgs Byte_DataReader_impl : public virtual Byte_DataReader,
            ...
            private:
                Byte_DataReader_impl (const Byte_DataReader_impl &);
                Byte_DataReader_impl & operator= (const Byte_DataReader_impl &);
            ...
            class ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_std_msgs Byte_DataReaderView_impl : public virtual Byte_DataReaderView,
            ...
            protected:
                ...
                virtual ~Byte_DataReaderView_impl ();
            ...
            private:
                Byte_DataReaderView_impl (const Byte_DataReaderView_impl &);
            
                Byte_DataReaderView_impl & operator= (const Byte_DataReaderView_impl &);
            };
