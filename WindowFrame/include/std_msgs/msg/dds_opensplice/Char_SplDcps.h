#ifndef H_D6BE7A5084520F40ABFE8ABDB423BA56_Char_SPLTYPES_H
#define H_D6BE7A5084520F40ABFE8ABDB423BA56_Char_SPLTYPES_H
...
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_std_msgs v_copyin_result __std_msgs_msg_dds__Char___copyIn(c_base base, const struct std_msgs::msg::dds_::Char_ *from, struct _std_msgs_msg_dds__Char_ *to);
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_std_msgs void __std_msgs_msg_dds__Char___copyOut(const void *_from, void *_to);
struct _std_msgs_msg_dds__Char_ {
    c_octet data_;
};
