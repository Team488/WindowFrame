#ifndef _H_9A6BD02DD9944F7A3CD9C883333C239E_Header_DCPS_H_
#define _H_9A6BD02DD9944F7A3CD9C883333C239E_Header_DCPS_H_
...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            ...
            class ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_std_msgs Header_TypeSupportInterface :
            ...
            class ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_std_msgs Header_DataWriter :
            ...
            class ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_std_msgs Header_DataReader :
            ...
            class ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_std_msgs Header_DataReaderView :
