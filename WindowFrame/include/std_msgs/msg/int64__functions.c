...
{
  std_msgs__msg__Int64 * msg = (std_msgs__msg__Int64 *)malloc(sizeof(std_msgs__msg__Int64));
  if (!msg) {
    return NULL;
  }
...
std_msgs__msg__Int64__Sequence__init(std_msgs__msg__Int64__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (std_msgs__msg__Int64 *)calloc(size, sizeof(std_msgs__msg__Int64));
    if (!data) {
      return false;
    }
...
{
  std_msgs__msg__Int64__Sequence * array = (std_msgs__msg__Int64__Sequence *)malloc(sizeof(std_msgs__msg__Int64__Sequence));
  if (!array) {
    return NULL;
  }
