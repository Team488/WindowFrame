...
void Bool__rosidl_typesupport_introspection_c__Bool_init_function(
...
void Bool__rosidl_typesupport_introspection_c__Bool_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers Bool__rosidl_typesupport_introspection_c__Bool_message_members = {
  ...
  Bool__rosidl_typesupport_introspection_c__Bool_init_function,  // function to initialize message memory (memory has to be allocated)
  Bool__rosidl_typesupport_introspection_c__Bool_fini_function  // function to terminate message instance (will not free memory)
};
