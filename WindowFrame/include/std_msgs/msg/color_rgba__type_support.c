...
void ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_init_function(
...
void ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_message_members = {
  ...
  ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_init_function,  // function to initialize message memory (memory has to be allocated)
  ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_fini_function  // function to terminate message instance (will not free memory)
};
