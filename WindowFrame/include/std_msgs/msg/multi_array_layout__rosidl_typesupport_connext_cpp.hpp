...
#include "std_msgs/msg/dds_connext/MultiArrayLayout_Support.h"
...
DDS_TypeCode *
get_type_code__MultiArrayLayout();
...
bool
to_cdr_stream__MultiArrayLayout(
  const void * untyped_ros_message,
  ConnextStaticCDRStream * cdr_stream);

bool
to_message__MultiArrayLayout(
...
#endif  // STD_MSGS__MSG__MULTI_ARRAY_LAYOUT__ROSIDL_TYPESUPPORT_CONNEXT_CPP_HPP_
