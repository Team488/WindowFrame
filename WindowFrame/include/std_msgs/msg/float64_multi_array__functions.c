...
std_msgs__msg__Float64MultiArray__init(std_msgs__msg__Float64MultiArray * msg)
{
  ...
  if (!std_msgs__msg__MultiArrayLayout__init(&msg->layout)) {
    std_msgs__msg__Float64MultiArray__destroy(msg);
    return false;
  }
  // data
...
{
  std_msgs__msg__Float64MultiArray__Sequence * array = (std_msgs__msg__Float64MultiArray__Sequence *)malloc(sizeof(std_msgs__msg__Float64MultiArray__Sequence));
  if (!array) {
    return NULL;
  }
