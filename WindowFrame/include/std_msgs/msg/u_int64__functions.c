...
{
  std_msgs__msg__UInt64 * msg = (std_msgs__msg__UInt64 *)malloc(sizeof(std_msgs__msg__UInt64));
  if (!msg) {
    return NULL;
  }
...
std_msgs__msg__UInt64__Sequence__init(std_msgs__msg__UInt64__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (std_msgs__msg__UInt64 *)calloc(size, sizeof(std_msgs__msg__UInt64));
    if (!data) {
      return false;
    }
...
{
  std_msgs__msg__UInt64__Sequence * array = (std_msgs__msg__UInt64__Sequence *)malloc(sizeof(std_msgs__msg__UInt64__Sequence));
  if (!array) {
    return NULL;
  }
