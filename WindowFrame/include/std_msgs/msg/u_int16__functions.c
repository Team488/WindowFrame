...
{
  std_msgs__msg__UInt16 * msg = (std_msgs__msg__UInt16 *)malloc(sizeof(std_msgs__msg__UInt16));
  if (!msg) {
    return NULL;
  }
...
std_msgs__msg__UInt16__Sequence__init(std_msgs__msg__UInt16__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (std_msgs__msg__UInt16 *)calloc(size, sizeof(std_msgs__msg__UInt16));
    if (!data) {
      return false;
    }
...
{
  std_msgs__msg__UInt16__Sequence * array = (std_msgs__msg__UInt16__Sequence *)malloc(sizeof(std_msgs__msg__UInt16__Sequence));
  if (!array) {
    return NULL;
  }
