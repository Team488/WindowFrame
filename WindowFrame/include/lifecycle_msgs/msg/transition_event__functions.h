...
#ifndef LIFECYCLE_MSGS__MSG__TRANSITION_EVENT__FUNCTIONS_H_
#define LIFECYCLE_MSGS__MSG__TRANSITION_EVENT__FUNCTIONS_H_
...
#endif  // LIFECYCLE_MSGS__MSG__TRANSITION_EVENT__FUNCTIONS_H_
