...
#ifndef LIFECYCLE_MSGS__SRV__CHANGE_STATE__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
#define LIFECYCLE_MSGS__SRV__CHANGE_STATE__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
// generated from
...
#include "lifecycle_msgs/srv/dds_opensplice/ccpp_ChangeState_.h"
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_lifecycle_msgs
extern void register_type__ChangeState_Response(
  DDS::DomainParticipant * participant,
  const char * type_name);
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_lifecycle_msgs
extern void publish__ChangeState_Response(
  DDS::DataWriter * topic_writer,
  const void * untyped_ros_message);
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_lifecycle_msgs
extern bool take__ChangeState_Response(
  DDS::DataReader * topic_reader,
  bool ignore_local_publications,
  void * untyped_ros_message,
  bool * taken);
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_lifecycle_msgs
const char *
serialize__ChangeState_Response(
  const void * untyped_ros_message,
  void * serialized_data);

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_lifecycle_msgs
const char *
deserialize__ChangeState_Response(
  const uint8_t * buffer,
  unsigned length,
  void * untyped_ros_message);
...
#endif
#endif  // LIFECYCLE_MSGS__SRV__CHANGE_STATE__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
