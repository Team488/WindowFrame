...
#ifndef LIFECYCLE_MSGS__SRV__GET_AVAILABLE_TRANSITIONS__FUNCTIONS_H_
#define LIFECYCLE_MSGS__SRV__GET_AVAILABLE_TRANSITIONS__FUNCTIONS_H_
...
#endif  // LIFECYCLE_MSGS__SRV__GET_AVAILABLE_TRANSITIONS__FUNCTIONS_H_
