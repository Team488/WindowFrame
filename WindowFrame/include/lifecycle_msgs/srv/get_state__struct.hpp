...
#ifndef LIFECYCLE_MSGS__SRV__GET_STATE__STRUCT_HPP_
#define LIFECYCLE_MSGS__SRV__GET_STATE__STRUCT_HPP_
...
struct GetState_Request_
{
  ...
  explicit GetState_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GetState_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // LIFECYCLE_MSGS__SRV__GET_STATE__STRUCT_HPP_
