...
#ifndef LIFECYCLE_MSGS__SRV__GET_AVAILABLE_TRANSITIONS__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
#define LIFECYCLE_MSGS__SRV__GET_AVAILABLE_TRANSITIONS__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
// generated from
...
#include "lifecycle_msgs/srv/dds_opensplice/ccpp_GetAvailableTransitions_.h"
...
const char *
serialize__GetAvailableTransitions_Request(
  const void * untyped_ros_message,
  void * serialized_data);

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_lifecycle_msgs
const char *
deserialize__GetAvailableTransitions_Request(
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_lifecycle_msgs
const char *
serialize__GetAvailableTransitions_Response(
  const void * untyped_ros_message,
  void * serialized_data);

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_lifecycle_msgs
const char *
deserialize__GetAvailableTransitions_Response(
  const uint8_t * buffer,
  unsigned length,
  void * untyped_ros_message);
...
#endif
#endif  // LIFECYCLE_MSGS__SRV__GET_AVAILABLE_TRANSITIONS__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
