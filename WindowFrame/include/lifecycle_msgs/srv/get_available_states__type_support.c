...
#include "lifecycle_msgs/srv/get_available_states__functions.h"
...
void GetAvailableStates_Request__rosidl_typesupport_introspection_c__GetAvailableStates_Request_init_function(
...
void GetAvailableStates_Request__rosidl_typesupport_introspection_c__GetAvailableStates_Request_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers GetAvailableStates_Request__rosidl_typesupport_introspection_c__GetAvailableStates_Request_message_members = {
  ...
  GetAvailableStates_Request__rosidl_typesupport_introspection_c__GetAvailableStates_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetAvailableStates_Request__rosidl_typesupport_introspection_c__GetAvailableStates_Request_fini_function  // function to terminate message instance (will not free memory)
};
...
void GetAvailableStates_Response__rosidl_typesupport_introspection_c__GetAvailableStates_Response_init_function(
  void * message_memory, enum rosidl_runtime_c_message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetAvailableStates_Response__rosidl_typesupport_introspection_c__GetAvailableStates_Response_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers GetAvailableStates_Response__rosidl_typesupport_introspection_c__GetAvailableStates_Response_message_members = {
  ...
  GetAvailableStates_Response__rosidl_typesupport_introspection_c__GetAvailableStates_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetAvailableStates_Response__rosidl_typesupport_introspection_c__GetAvailableStates_Response_fini_function  // function to terminate message instance (will not free memory)
};
