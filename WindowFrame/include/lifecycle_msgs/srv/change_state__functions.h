...
#ifndef LIFECYCLE_MSGS__SRV__CHANGE_STATE__FUNCTIONS_H_
#define LIFECYCLE_MSGS__SRV__CHANGE_STATE__FUNCTIONS_H_
...
#endif  // LIFECYCLE_MSGS__SRV__CHANGE_STATE__FUNCTIONS_H_
