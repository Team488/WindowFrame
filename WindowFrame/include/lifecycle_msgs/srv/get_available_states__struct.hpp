...
#ifndef LIFECYCLE_MSGS__SRV__GET_AVAILABLE_STATES__STRUCT_HPP_
#define LIFECYCLE_MSGS__SRV__GET_AVAILABLE_STATES__STRUCT_HPP_
...
struct GetAvailableStates_Response_
{
  ...
  explicit GetAvailableStates_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit GetAvailableStates_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
#endif  // LIFECYCLE_MSGS__SRV__GET_AVAILABLE_STATES__STRUCT_HPP_
