...
#ifndef LIFECYCLE_MSGS__SRV__GET_AVAILABLE_STATES__STRUCT_H_
#define LIFECYCLE_MSGS__SRV__GET_AVAILABLE_STATES__STRUCT_H_
...
#endif  // LIFECYCLE_MSGS__SRV__GET_AVAILABLE_STATES__STRUCT_H_
