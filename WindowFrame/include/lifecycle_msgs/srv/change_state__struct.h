...
#ifndef LIFECYCLE_MSGS__SRV__CHANGE_STATE__STRUCT_H_
#define LIFECYCLE_MSGS__SRV__CHANGE_STATE__STRUCT_H_
...
#endif  // LIFECYCLE_MSGS__SRV__CHANGE_STATE__STRUCT_H_
