...
#ifndef VISUALIZATION_MSGS__MSG__IMAGE_MARKER__FUNCTIONS_H_
#define VISUALIZATION_MSGS__MSG__IMAGE_MARKER__FUNCTIONS_H_
...
#endif  // VISUALIZATION_MSGS__MSG__IMAGE_MARKER__FUNCTIONS_H_
