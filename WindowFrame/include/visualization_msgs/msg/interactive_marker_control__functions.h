...
#ifndef VISUALIZATION_MSGS__MSG__INTERACTIVE_MARKER_CONTROL__FUNCTIONS_H_
#define VISUALIZATION_MSGS__MSG__INTERACTIVE_MARKER_CONTROL__FUNCTIONS_H_
...
#endif  // VISUALIZATION_MSGS__MSG__INTERACTIVE_MARKER_CONTROL__FUNCTIONS_H_
