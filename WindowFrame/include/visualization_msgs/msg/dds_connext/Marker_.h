...
#ifndef Marker__1893984142_h
#define Marker__1893984142_h
    ...
    namespace msg {
        namespace dds_ {
            namespace Marker_Constants {
                static const DDS_Octet ARROW_= 0;
                static const DDS_Octet CUBE_= 1;
                static const DDS_Octet SPHERE_= 2;
                static const DDS_Octet CYLINDER_= 3;
                static const DDS_Octet LINE_STRIP_= 4;
                static const DDS_Octet LINE_LIST_= 5;
                static const DDS_Octet CUBE_LIST_= 6;
                static const DDS_Octet SPHERE_LIST_= 7;
                static const DDS_Octet POINTS_= 8;
                static const DDS_Octet TEXT_VIEW_FACING_= 9;
                static const DDS_Octet MESH_RESOURCE_= 10;
                static const DDS_Octet TRIANGLE_LIST_= 11;
                static const DDS_Octet ADD_= 0;
                static const DDS_Octet MODIFY_= 0;
                static const DDS_Octet DELETE_= 2;
                static const DDS_Octet DELETEALL_= 3;
            } /* namespace Marker_Constants  */
