...
#ifndef ImageMarker_Plugin_1698717970_h
#define ImageMarker_Plugin_1698717970_h
...
namespace visualization_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define ImageMarker_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define ImageMarker_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define ImageMarker_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define ImageMarker_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define ImageMarker_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern ImageMarker_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            ImageMarker_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                ImageMarker_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            ImageMarker_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ImageMarker_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            ImageMarker_Plugin_new(void);

            NDDSUSERDllExport extern void
            ImageMarker_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* ImageMarker_Plugin_1698717970_h */
