...
#ifndef ImageMarker__1698717970_h
#define ImageMarker__1698717970_h
    ...
    namespace msg {
        namespace dds_ {
            namespace ImageMarker_Constants {
                static const DDS_Octet CIRCLE_= 0;
                static const DDS_Octet LINE_STRIP_= 1;
                static const DDS_Octet LINE_LIST_= 2;
                static const DDS_Octet POLYGON_= 3;
                static const DDS_Octet POINTS_= 4;
                static const DDS_Octet ADD_= 0;
                static const DDS_Octet REMOVE_= 1;
            } /* namespace ImageMarker_Constants  */
