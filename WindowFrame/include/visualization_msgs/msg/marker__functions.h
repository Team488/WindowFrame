...
#ifndef VISUALIZATION_MSGS__MSG__MARKER__FUNCTIONS_H_
#define VISUALIZATION_MSGS__MSG__MARKER__FUNCTIONS_H_
...
#endif  // VISUALIZATION_MSGS__MSG__MARKER__FUNCTIONS_H_
