...
#ifndef VISUALIZATION_MSGS__SRV__GET_INTERACTIVE_MARKERS__TYPE_SUPPORT_H_
#define VISUALIZATION_MSGS__SRV__GET_INTERACTIVE_MARKERS__TYPE_SUPPORT_H_
...
#endif  // VISUALIZATION_MSGS__SRV__GET_INTERACTIVE_MARKERS__TYPE_SUPPORT_H_
