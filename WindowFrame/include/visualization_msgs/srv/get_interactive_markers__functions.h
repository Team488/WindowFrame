...
#ifndef VISUALIZATION_MSGS__SRV__GET_INTERACTIVE_MARKERS__FUNCTIONS_H_
#define VISUALIZATION_MSGS__SRV__GET_INTERACTIVE_MARKERS__FUNCTIONS_H_
...
#endif  // VISUALIZATION_MSGS__SRV__GET_INTERACTIVE_MARKERS__FUNCTIONS_H_
