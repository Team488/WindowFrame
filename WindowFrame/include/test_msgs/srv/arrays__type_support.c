...
#include <stddef.h>
#include "test_msgs/srv/arrays__rosidl_typesupport_introspection_c.h"
#include "test_msgs/msg/rosidl_typesupport_introspection_c__visibility_control.h"
#include "rosidl_typesupport_introspection_c/field_types.h"
#include "rosidl_typesupport_introspection_c/identifier.h"
#include "rosidl_typesupport_introspection_c/message_introspection.h"
#include "test_msgs/srv/arrays__functions.h"
#include "test_msgs/srv/arrays__struct.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers test_msgs__srv__arrays__rosidl_typesupport_introspection_c__Arrays_service_members = {
  "test_msgs__srv",  // service namespace
  "Arrays",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // test_msgs__srv__arrays__rosidl_typesupport_introspection_c__Arrays_Request_message_type_support_handle,
  NULL  // response message
  // test_msgs__srv__arrays__rosidl_typesupport_introspection_c__Arrays_Response_message_type_support_handle
};

static rosidl_service_type_support_t test_msgs__srv__arrays__rosidl_typesupport_introspection_c__Arrays_service_type_support_handle = {
  0,
  &test_msgs__srv__arrays__rosidl_typesupport_introspection_c__Arrays_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_msgs, srv, Arrays)() {
  if (!test_msgs__srv__arrays__rosidl_typesupport_introspection_c__Arrays_service_type_support_handle.typesupport_identifier) {
    test_msgs__srv__arrays__rosidl_typesupport_introspection_c__Arrays_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)test_msgs__srv__arrays__rosidl_typesupport_introspection_c__Arrays_service_type_support_handle.data;
  ...
  return &test_msgs__srv__arrays__rosidl_typesupport_introspection_c__Arrays_service_type_support_handle;
}
