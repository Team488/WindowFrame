...
#ifndef TEST_MSGS__SRV__ARRAYS__STRUCT_HPP_
#define TEST_MSGS__SRV__ARRAYS__STRUCT_HPP_
...
struct Arrays_Request_
{
  ...
  explicit Arrays_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit Arrays_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : bool_values(_alloc),
    byte_values(_alloc),
    char_values(_alloc),
...
struct Arrays_Response_
{
  ...
  explicit Arrays_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::DEFAULTS_ONLY == _init)
    {
  ...
  explicit Arrays_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : bool_values(_alloc),
    byte_values(_alloc),
    char_values(_alloc),
    float32_values(_alloc),
...
#endif  // TEST_MSGS__SRV__ARRAYS__STRUCT_HPP_
