...
void BoundedSequences__rosidl_typesupport_introspection_c__BoundedSequences_init_function(
...
void BoundedSequences__rosidl_typesupport_introspection_c__BoundedSequences_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers BoundedSequences__rosidl_typesupport_introspection_c__BoundedSequences_message_members = {
  ...
  BoundedSequences__rosidl_typesupport_introspection_c__BoundedSequences_init_function,  // function to initialize message memory (memory has to be allocated)
  BoundedSequences__rosidl_typesupport_introspection_c__BoundedSequences_fini_function  // function to terminate message instance (will not free memory)
};
