...
void Builtins__rosidl_typesupport_introspection_c__Builtins_init_function(
...
void Builtins__rosidl_typesupport_introspection_c__Builtins_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers Builtins__rosidl_typesupport_introspection_c__Builtins_message_members = {
  ...
  Builtins__rosidl_typesupport_introspection_c__Builtins_init_function,  // function to initialize message memory (memory has to be allocated)
  Builtins__rosidl_typesupport_introspection_c__Builtins_fini_function  // function to terminate message instance (will not free memory)
};
