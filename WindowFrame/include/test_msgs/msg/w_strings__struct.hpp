...
#ifndef TEST_MSGS__MSG__W_STRINGS__STRUCT_HPP_
#define TEST_MSGS__MSG__W_STRINGS__STRUCT_HPP_
...
struct WStrings_
{
  ...
  Type & set__bounded_sequence_of_wstrings(
    const rosidl_generator_cpp::BoundedVector<std::basic_string<char16_t, std::char_traits<char16_t>, typename ContainerAllocator::template rebind<char16_t>::other>, 3, typename ContainerAllocator::template rebind<std::basic_string<char16_t, std::char_traits<char16_t>, typename ContainerAllocator::template rebind<char16_t>::other>>::other> & _arg)
  {
...
#endif  // TEST_MSGS__MSG__W_STRINGS__STRUCT_HPP_
