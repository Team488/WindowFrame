...
#ifndef TEST_MSGS__MSG__BOUNDED_SEQUENCES__STRUCT_H_
#define TEST_MSGS__MSG__BOUNDED_SEQUENCES__STRUCT_H_
...
#endif  // TEST_MSGS__MSG__BOUNDED_SEQUENCES__STRUCT_H_
