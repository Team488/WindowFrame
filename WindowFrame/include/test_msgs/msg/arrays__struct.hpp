...
#ifndef TEST_MSGS__MSG__ARRAYS__STRUCT_HPP_
#define TEST_MSGS__MSG__ARRAYS__STRUCT_HPP_
...
struct Arrays_
{
  ...
  explicit Arrays_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit Arrays_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : bool_values(_alloc),
    byte_values(_alloc),
    char_values(_alloc),
...
#endif  // TEST_MSGS__MSG__ARRAYS__STRUCT_HPP_
