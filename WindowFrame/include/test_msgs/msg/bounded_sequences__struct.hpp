...
#ifndef TEST_MSGS__MSG__BOUNDED_SEQUENCES__STRUCT_HPP_
#define TEST_MSGS__MSG__BOUNDED_SEQUENCES__STRUCT_HPP_
...
#include "test_msgs/msg/constants__struct.hpp"
...
struct BoundedSequences_
{
  ...
  explicit BoundedSequences_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit BoundedSequences_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::DEFAULTS_ONLY == _init)
  ...
  using _byte_values_type =
    rosidl_generator_cpp::BoundedVector<unsigned char, 3, typename ContainerAllocator::template rebind<unsigned char>::other>;
  ...
  using _basic_types_values_type =
    rosidl_generator_cpp::BoundedVector<test_msgs::msg::BasicTypes_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::BasicTypes_<ContainerAllocator>>::other>;
  _basic_types_values_type basic_types_values;
  using _constants_values_type =
    rosidl_generator_cpp::BoundedVector<test_msgs::msg::Constants_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::Constants_<ContainerAllocator>>::other>;
  _constants_values_type constants_values;
  using _defaults_values_type =
    rosidl_generator_cpp::BoundedVector<test_msgs::msg::Defaults_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::Defaults_<ContainerAllocator>>::other>;
  ...
  Type & set__byte_values(
    const rosidl_generator_cpp::BoundedVector<unsigned char, 3, typename ContainerAllocator::template rebind<unsigned char>::other> & _arg)
  {
  ...
  Type & set__basic_types_values(
    const rosidl_generator_cpp::BoundedVector<test_msgs::msg::BasicTypes_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::BasicTypes_<ContainerAllocator>>::other> & _arg)
  {
    this->basic_types_values = _arg;
    return *this;
  }
  Type & set__constants_values(
    const rosidl_generator_cpp::BoundedVector<test_msgs::msg::Constants_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::Constants_<ContainerAllocator>>::other> & _arg)
  {
    this->constants_values = _arg;
    return *this;
  }
  Type & set__defaults_values(
    const rosidl_generator_cpp::BoundedVector<test_msgs::msg::Defaults_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::Defaults_<ContainerAllocator>>::other> & _arg)
  {
...
#endif  // TEST_MSGS__MSG__BOUNDED_SEQUENCES__STRUCT_HPP_
