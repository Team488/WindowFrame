...
#ifndef TEST_MSGS__MSG__UNBOUNDED_SEQUENCES__STRUCT_HPP_
#define TEST_MSGS__MSG__UNBOUNDED_SEQUENCES__STRUCT_HPP_
...
struct UnboundedSequences_
{
  ...
  explicit UnboundedSequences_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit UnboundedSequences_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::DEFAULTS_ONLY == _init)
...
#endif  // TEST_MSGS__MSG__UNBOUNDED_SEQUENCES__STRUCT_HPP_
