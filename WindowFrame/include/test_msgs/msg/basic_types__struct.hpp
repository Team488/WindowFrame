...
#ifndef TEST_MSGS__MSG__BASIC_TYPES__STRUCT_HPP_
#define TEST_MSGS__MSG__BASIC_TYPES__STRUCT_HPP_
...
struct BasicTypes_
{
  ...
  explicit BasicTypes_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit BasicTypes_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // TEST_MSGS__MSG__BASIC_TYPES__STRUCT_HPP_
