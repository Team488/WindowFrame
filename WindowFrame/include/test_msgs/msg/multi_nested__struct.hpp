...
#ifndef TEST_MSGS__MSG__MULTI_NESTED__STRUCT_HPP_
#define TEST_MSGS__MSG__MULTI_NESTED__STRUCT_HPP_
...
#include "test_msgs/msg/arrays__struct.hpp"
...
#include "test_msgs/msg/unbounded_sequences__struct.hpp"
...
struct MultiNested_
{
  ...
  using _bounded_sequence_of_arrays_type =
    rosidl_generator_cpp::BoundedVector<test_msgs::msg::Arrays_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::Arrays_<ContainerAllocator>>::other>;
  _bounded_sequence_of_arrays_type bounded_sequence_of_arrays;
  using _bounded_sequence_of_bounded_sequences_type =
    rosidl_generator_cpp::BoundedVector<test_msgs::msg::BoundedSequences_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::BoundedSequences_<ContainerAllocator>>::other>;
  ...
  using _bounded_sequence_of_unbounded_sequences_type =
    rosidl_generator_cpp::BoundedVector<test_msgs::msg::UnboundedSequences_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::UnboundedSequences_<ContainerAllocator>>::other>;
  ...
  Type & set__bounded_sequence_of_arrays(
    const rosidl_generator_cpp::BoundedVector<test_msgs::msg::Arrays_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::Arrays_<ContainerAllocator>>::other> & _arg)
  {
    this->bounded_sequence_of_arrays = _arg;
    return *this;
  }
  Type & set__bounded_sequence_of_bounded_sequences(
    const rosidl_generator_cpp::BoundedVector<test_msgs::msg::BoundedSequences_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::BoundedSequences_<ContainerAllocator>>::other> & _arg)
  {
    this->bounded_sequence_of_bounded_sequences = _arg;
    return *this;
  }
  Type & set__bounded_sequence_of_unbounded_sequences(
    const rosidl_generator_cpp::BoundedVector<test_msgs::msg::UnboundedSequences_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<test_msgs::msg::UnboundedSequences_<ContainerAllocator>>::other> & _arg)
  {
...
#endif  // TEST_MSGS__MSG__MULTI_NESTED__STRUCT_HPP_
