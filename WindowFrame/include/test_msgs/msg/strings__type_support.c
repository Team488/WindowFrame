...
#include <stddef.h>
#include "test_msgs/msg/strings__rosidl_typesupport_introspection_c.h"
...
void Strings__rosidl_typesupport_introspection_c__Strings_init_function(
...
void Strings__rosidl_typesupport_introspection_c__Strings_fini_function(void * message_memory)
{
  test_msgs__msg__Strings__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Strings__rosidl_typesupport_introspection_c__Strings_message_member_array[12] = {
  {
    "string_value",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers Strings__rosidl_typesupport_introspection_c__Strings_message_members = {
  "test_msgs__msg",  // message namespace
  "Strings",  // message name
  12,  // number of fields
  sizeof(test_msgs__msg__Strings),
  Strings__rosidl_typesupport_introspection_c__Strings_message_member_array,  // message members
  Strings__rosidl_typesupport_introspection_c__Strings_init_function,  // function to initialize message memory (memory has to be allocated)
  Strings__rosidl_typesupport_introspection_c__Strings_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t Strings__rosidl_typesupport_introspection_c__Strings_message_type_support_handle = {
  0,
  &Strings__rosidl_typesupport_introspection_c__Strings_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_msgs, msg, Strings)() {
  if (!Strings__rosidl_typesupport_introspection_c__Strings_message_type_support_handle.typesupport_identifier) {
    Strings__rosidl_typesupport_introspection_c__Strings_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &Strings__rosidl_typesupport_introspection_c__Strings_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
