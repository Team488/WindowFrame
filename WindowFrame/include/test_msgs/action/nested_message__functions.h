...
#ifndef TEST_MSGS__ACTION__NESTED_MESSAGE__FUNCTIONS_H_
#define TEST_MSGS__ACTION__NESTED_MESSAGE__FUNCTIONS_H_
...
#endif  // TEST_MSGS__ACTION__NESTED_MESSAGE__FUNCTIONS_H_
