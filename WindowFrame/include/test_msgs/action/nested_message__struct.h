...
#ifndef TEST_MSGS__ACTION__NESTED_MESSAGE__STRUCT_H_
#define TEST_MSGS__ACTION__NESTED_MESSAGE__STRUCT_H_
...
#endif  // TEST_MSGS__ACTION__NESTED_MESSAGE__STRUCT_H_
