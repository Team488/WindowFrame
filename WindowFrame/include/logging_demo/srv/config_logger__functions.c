...
logging_demo__srv__ConfigLogger_Request__init(logging_demo__srv__ConfigLogger_Request * msg)
{
  ...
  // logger_name
  if (!rosidl_generator_c__String__init(&msg->logger_name)) {
    logging_demo__srv__ConfigLogger_Request__destroy(msg);
    return false;
  }
  // level
  if (!rosidl_generator_c__String__init(&msg->level)) {
    logging_demo__srv__ConfigLogger_Request__destroy(msg);
    return false;
  }
  return true;
...
logging_demo__srv__ConfigLogger_Request__fini(logging_demo__srv__ConfigLogger_Request * msg)
{
  ...
  // logger_name
  rosidl_generator_c__String__fini(&msg->logger_name);
  // level
  rosidl_generator_c__String__fini(&msg->level);
}
