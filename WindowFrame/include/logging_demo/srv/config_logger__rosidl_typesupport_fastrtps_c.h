...
#ifndef LOGGING_DEMO__SRV__CONFIG_LOGGER__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
#define LOGGING_DEMO__SRV__CONFIG_LOGGER__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
...
#endif  // LOGGING_DEMO__SRV__CONFIG_LOGGER__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
