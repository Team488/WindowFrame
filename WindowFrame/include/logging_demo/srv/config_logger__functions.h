...
#ifndef LOGGING_DEMO__SRV__CONFIG_LOGGER__FUNCTIONS_H_
#define LOGGING_DEMO__SRV__CONFIG_LOGGER__FUNCTIONS_H_
...
#endif  // LOGGING_DEMO__SRV__CONFIG_LOGGER__FUNCTIONS_H_
