...
#include <stddef.h>
#include "logging_demo/srv/config_logger__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers logging_demo__srv__config_logger__rosidl_typesupport_introspection_c__ConfigLogger_service_members = {
  "logging_demo__srv",  // service namespace
  "ConfigLogger",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // logging_demo__srv__config_logger__rosidl_typesupport_introspection_c__ConfigLogger_Request_message_type_support_handle,
  NULL  // response message
  // logging_demo__srv__config_logger__rosidl_typesupport_introspection_c__ConfigLogger_Response_message_type_support_handle
};

static rosidl_service_type_support_t logging_demo__srv__config_logger__rosidl_typesupport_introspection_c__ConfigLogger_service_type_support_handle = {
  0,
  &logging_demo__srv__config_logger__rosidl_typesupport_introspection_c__ConfigLogger_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, logging_demo, srv, ConfigLogger)() {
  if (!logging_demo__srv__config_logger__rosidl_typesupport_introspection_c__ConfigLogger_service_type_support_handle.typesupport_identifier) {
    logging_demo__srv__config_logger__rosidl_typesupport_introspection_c__ConfigLogger_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)logging_demo__srv__config_logger__rosidl_typesupport_introspection_c__ConfigLogger_service_type_support_handle.data;
  ...
  return &logging_demo__srv__config_logger__rosidl_typesupport_introspection_c__ConfigLogger_service_type_support_handle;
}
