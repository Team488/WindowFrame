...
trajectory_msgs__msg__JointTrajectoryPoint__init(trajectory_msgs__msg__JointTrajectoryPoint * msg)
{
  ...
  // positions
  if (!rosidl_generator_c__double__Sequence__init(&msg->positions, 0)) {
    trajectory_msgs__msg__JointTrajectoryPoint__destroy(msg);
    return false;
  }
  // velocities
  if (!rosidl_generator_c__double__Sequence__init(&msg->velocities, 0)) {
    trajectory_msgs__msg__JointTrajectoryPoint__destroy(msg);
    return false;
  }
  // accelerations
  if (!rosidl_generator_c__double__Sequence__init(&msg->accelerations, 0)) {
    trajectory_msgs__msg__JointTrajectoryPoint__destroy(msg);
    return false;
  }
  // effort
  if (!rosidl_generator_c__double__Sequence__init(&msg->effort, 0)) {
    trajectory_msgs__msg__JointTrajectoryPoint__destroy(msg);
    return false;
  }
  // time_from_start
...
trajectory_msgs__msg__JointTrajectoryPoint__fini(trajectory_msgs__msg__JointTrajectoryPoint * msg)
{
  ...
  // positions
  rosidl_generator_c__double__Sequence__fini(&msg->positions);
  // velocities
  rosidl_generator_c__double__Sequence__fini(&msg->velocities);
  // accelerations
  rosidl_generator_c__double__Sequence__fini(&msg->accelerations);
  // effort
  rosidl_generator_c__double__Sequence__fini(&msg->effort);
  // time_from_start
