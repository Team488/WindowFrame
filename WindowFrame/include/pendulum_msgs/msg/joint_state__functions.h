...
#ifndef PENDULUM_MSGS__MSG__JOINT_STATE__FUNCTIONS_H_
#define PENDULUM_MSGS__MSG__JOINT_STATE__FUNCTIONS_H_
...
#endif  // PENDULUM_MSGS__MSG__JOINT_STATE__FUNCTIONS_H_
