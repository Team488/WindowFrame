...
#ifndef ACTIONLIB_MSGS__MSG__GOAL_STATUS_ARRAY__FUNCTIONS_H_
#define ACTIONLIB_MSGS__MSG__GOAL_STATUS_ARRAY__FUNCTIONS_H_
...
#endif  // ACTIONLIB_MSGS__MSG__GOAL_STATUS_ARRAY__FUNCTIONS_H_
