...
#ifndef SENSOR_MSGS__SRV__SET_CAMERA_INFO__STRUCT_HPP_
#define SENSOR_MSGS__SRV__SET_CAMERA_INFO__STRUCT_HPP_
...
struct SetCameraInfo_Request_
{
  ...
  explicit SetCameraInfo_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : camera_info(_init)
  {
    (void)_init;
  }

  explicit SetCameraInfo_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
struct SetCameraInfo_Response_
{
  ...
  explicit SetCameraInfo_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit SetCameraInfo_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // SENSOR_MSGS__SRV__SET_CAMERA_INFO__STRUCT_HPP_
