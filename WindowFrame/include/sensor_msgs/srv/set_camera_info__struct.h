...
#ifndef SENSOR_MSGS__SRV__SET_CAMERA_INFO__STRUCT_H_
#define SENSOR_MSGS__SRV__SET_CAMERA_INFO__STRUCT_H_
...
#endif  // SENSOR_MSGS__SRV__SET_CAMERA_INFO__STRUCT_H_
