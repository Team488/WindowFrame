...
#ifndef SENSOR_MSGS__SRV__SET_CAMERA_INFO__FUNCTIONS_H_
#define SENSOR_MSGS__SRV__SET_CAMERA_INFO__FUNCTIONS_H_
...
#endif  // SENSOR_MSGS__SRV__SET_CAMERA_INFO__FUNCTIONS_H_
