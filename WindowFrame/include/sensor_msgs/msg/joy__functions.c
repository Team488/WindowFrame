...
sensor_msgs__msg__Joy__init(sensor_msgs__msg__Joy * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    sensor_msgs__msg__Joy__destroy(msg);
    return false;
  }
  // axes
  if (!rosidl_generator_c__float__Sequence__init(&msg->axes, 0)) {
    sensor_msgs__msg__Joy__destroy(msg);
    return false;
  }
  // buttons
  if (!rosidl_generator_c__int32__Sequence__init(&msg->buttons, 0)) {
    sensor_msgs__msg__Joy__destroy(msg);
    return false;
  }
  return true;
...
sensor_msgs__msg__Joy__fini(sensor_msgs__msg__Joy * msg)
{
  ...
  // axes
  rosidl_generator_c__float__Sequence__fini(&msg->axes);
  // buttons
  rosidl_generator_c__int32__Sequence__fini(&msg->buttons);
}
