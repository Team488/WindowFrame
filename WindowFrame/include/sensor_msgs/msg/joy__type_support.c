...
void Joy__rosidl_typesupport_introspection_c__Joy_init_function(
...
void Joy__rosidl_typesupport_introspection_c__Joy_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers Joy__rosidl_typesupport_introspection_c__Joy_message_members = {
  ...
  Joy__rosidl_typesupport_introspection_c__Joy_init_function,  // function to initialize message memory (memory has to be allocated)
  Joy__rosidl_typesupport_introspection_c__Joy_fini_function  // function to terminate message instance (will not free memory)
};
