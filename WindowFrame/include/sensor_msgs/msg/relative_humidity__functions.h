...
#ifndef SENSOR_MSGS__MSG__RELATIVE_HUMIDITY__FUNCTIONS_H_
#define SENSOR_MSGS__MSG__RELATIVE_HUMIDITY__FUNCTIONS_H_
...
#endif  // SENSOR_MSGS__MSG__RELATIVE_HUMIDITY__FUNCTIONS_H_
