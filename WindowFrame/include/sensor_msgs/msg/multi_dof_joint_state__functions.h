...
#ifndef SENSOR_MSGS__MSG__MULTI_DOF_JOINT_STATE__FUNCTIONS_H_
#define SENSOR_MSGS__MSG__MULTI_DOF_JOINT_STATE__FUNCTIONS_H_
...
#endif  // SENSOR_MSGS__MSG__MULTI_DOF_JOINT_STATE__FUNCTIONS_H_
