...
void CameraInfo__rosidl_typesupport_introspection_c__CameraInfo_init_function(
...
void CameraInfo__rosidl_typesupport_introspection_c__CameraInfo_fini_function(void * message_memory)
{
  sensor_msgs__msg__CameraInfo__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember CameraInfo__rosidl_typesupport_introspection_c__CameraInfo_message_member_array[11] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers CameraInfo__rosidl_typesupport_introspection_c__CameraInfo_message_members = {
  "sensor_msgs__msg",  // message namespace
  "CameraInfo",  // message name
  11,  // number of fields
  sizeof(sensor_msgs__msg__CameraInfo),
  CameraInfo__rosidl_typesupport_introspection_c__CameraInfo_message_member_array,  // message members
  CameraInfo__rosidl_typesupport_introspection_c__CameraInfo_init_function,  // function to initialize message memory (memory has to be allocated)
  CameraInfo__rosidl_typesupport_introspection_c__CameraInfo_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t CameraInfo__rosidl_typesupport_introspection_c__CameraInfo_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, msg, CameraInfo)() {
  CameraInfo__rosidl_typesupport_introspection_c__CameraInfo_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  CameraInfo__rosidl_typesupport_introspection_c__CameraInfo_message_member_array[10].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, msg, RegionOfInterest)();
  if (!CameraInfo__rosidl_typesupport_introspection_c__CameraInfo_message_type_support_handle.typesupport_identifier) {
    CameraInfo__rosidl_typesupport_introspection_c__CameraInfo_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &CameraInfo__rosidl_typesupport_introspection_c__CameraInfo_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
