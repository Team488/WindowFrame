...
void LaserScan__rosidl_typesupport_introspection_c__LaserScan_init_function(
...
void LaserScan__rosidl_typesupport_introspection_c__LaserScan_fini_function(void * message_memory)
{
  sensor_msgs__msg__LaserScan__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember LaserScan__rosidl_typesupport_introspection_c__LaserScan_message_member_array[10] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers LaserScan__rosidl_typesupport_introspection_c__LaserScan_message_members = {
  "sensor_msgs__msg",  // message namespace
  "LaserScan",  // message name
  10,  // number of fields
  sizeof(sensor_msgs__msg__LaserScan),
  LaserScan__rosidl_typesupport_introspection_c__LaserScan_message_member_array,  // message members
  LaserScan__rosidl_typesupport_introspection_c__LaserScan_init_function,  // function to initialize message memory (memory has to be allocated)
  LaserScan__rosidl_typesupport_introspection_c__LaserScan_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t LaserScan__rosidl_typesupport_introspection_c__LaserScan_message_type_support_handle = {
  0,
  &LaserScan__rosidl_typesupport_introspection_c__LaserScan_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, msg, LaserScan)() {
  LaserScan__rosidl_typesupport_introspection_c__LaserScan_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!LaserScan__rosidl_typesupport_introspection_c__LaserScan_message_type_support_handle.typesupport_identifier) {
    LaserScan__rosidl_typesupport_introspection_c__LaserScan_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &LaserScan__rosidl_typesupport_introspection_c__LaserScan_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
