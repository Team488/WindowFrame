...
sensor_msgs__msg__LaserScan__init(sensor_msgs__msg__LaserScan * msg)
{
  ...
  // range_max
  // ranges
  if (!rosidl_generator_c__float__Sequence__init(&msg->ranges, 0)) {
    sensor_msgs__msg__LaserScan__destroy(msg);
    return false;
  }
  // intensities
  if (!rosidl_generator_c__float__Sequence__init(&msg->intensities, 0)) {
    sensor_msgs__msg__LaserScan__destroy(msg);
    return false;
  }
  return true;
...
sensor_msgs__msg__LaserScan__fini(sensor_msgs__msg__LaserScan * msg)
{
  ...
  // range_max
  // ranges
  rosidl_generator_c__float__Sequence__fini(&msg->ranges);
  // intensities
  rosidl_generator_c__float__Sequence__fini(&msg->intensities);
}
