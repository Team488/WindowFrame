...
sensor_msgs__msg__BatteryState__init(sensor_msgs__msg__BatteryState * msg)
{
  ...
  // present
  // cell_voltage
  if (!rosidl_generator_c__float__Sequence__init(&msg->cell_voltage, 0)) {
    sensor_msgs__msg__BatteryState__destroy(msg);
    return false;
  }
  // cell_temperature
  if (!rosidl_generator_c__float__Sequence__init(&msg->cell_temperature, 0)) {
    sensor_msgs__msg__BatteryState__destroy(msg);
    return false;
  }
  // location
...
sensor_msgs__msg__BatteryState__fini(sensor_msgs__msg__BatteryState * msg)
{
  ...
  // present
  // cell_voltage
  rosidl_generator_c__float__Sequence__fini(&msg->cell_voltage);
  // cell_temperature
  rosidl_generator_c__float__Sequence__fini(&msg->cell_temperature);
  // location
