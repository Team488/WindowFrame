...
#ifndef SENSOR_MSGS__MSG__MAGNETIC_FIELD__FUNCTIONS_H_
#define SENSOR_MSGS__MSG__MAGNETIC_FIELD__FUNCTIONS_H_
...
#endif  // SENSOR_MSGS__MSG__MAGNETIC_FIELD__FUNCTIONS_H_
