...
sensor_msgs__msg__ChannelFloat32__init(sensor_msgs__msg__ChannelFloat32 * msg)
{
  ...
  if (!rosidl_generator_c__String__init(&msg->name)) {
    sensor_msgs__msg__ChannelFloat32__destroy(msg);
    return false;
  }
  // values
  if (!rosidl_generator_c__float__Sequence__init(&msg->values, 0)) {
    sensor_msgs__msg__ChannelFloat32__destroy(msg);
    return false;
  }
  return true;
...
sensor_msgs__msg__ChannelFloat32__fini(sensor_msgs__msg__ChannelFloat32 * msg)
{
  ...
  // values
  rosidl_generator_c__float__Sequence__fini(&msg->values);
}
