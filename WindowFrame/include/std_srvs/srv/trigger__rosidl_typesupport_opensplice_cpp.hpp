...
#ifndef STD_SRVS__SRV__TRIGGER__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
#define STD_SRVS__SRV__TRIGGER__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
// generated from
...
#include "std_srvs/srv/dds_opensplice/ccpp_Trigger_.h"
...
const char *
serialize__Trigger_Request(
  const void * untyped_ros_message,
  void * serialized_data);

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_std_srvs
const char *
deserialize__Trigger_Request(
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_std_srvs
const char *
serialize__Trigger_Response(
  const void * untyped_ros_message,
  void * serialized_data);

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_std_srvs
const char *
deserialize__Trigger_Response(
  const uint8_t * buffer,
  unsigned length,
  void * untyped_ros_message);
...
#endif
#endif  // STD_SRVS__SRV__TRIGGER__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
