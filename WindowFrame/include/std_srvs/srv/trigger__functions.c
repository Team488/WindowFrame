...
{
  std_srvs__srv__Trigger_Request * msg = (std_srvs__srv__Trigger_Request *)malloc(sizeof(std_srvs__srv__Trigger_Request));
  if (!msg) {
    return NULL;
  }
...
std_srvs__srv__Trigger_Request__Sequence__init(std_srvs__srv__Trigger_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (std_srvs__srv__Trigger_Request *)calloc(size, sizeof(std_srvs__srv__Trigger_Request));
    if (!data) {
      return false;
    }
...
{
  std_srvs__srv__Trigger_Request__Sequence * array = (std_srvs__srv__Trigger_Request__Sequence *)malloc(sizeof(std_srvs__srv__Trigger_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  std_srvs__srv__Trigger_Response__Sequence * array = (std_srvs__srv__Trigger_Response__Sequence *)malloc(sizeof(std_srvs__srv__Trigger_Response__Sequence));
  if (!array) {
    return NULL;
  }
