...
#include "std_srvs/srv/trigger__functions.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers std_srvs__srv__trigger__rosidl_typesupport_introspection_c__Trigger_service_members = {
  "std_srvs__srv",  // service namespace
  "Trigger",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // std_srvs__srv__trigger__rosidl_typesupport_introspection_c__Trigger_Request_message_type_support_handle,
  NULL  // response message
  // std_srvs__srv__trigger__rosidl_typesupport_introspection_c__Trigger_Response_message_type_support_handle
};

static rosidl_service_type_support_t std_srvs__srv__trigger__rosidl_typesupport_introspection_c__Trigger_service_type_support_handle = {
  0,
  &std_srvs__srv__trigger__rosidl_typesupport_introspection_c__Trigger_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_srvs, srv, Trigger)() {
  if (!std_srvs__srv__trigger__rosidl_typesupport_introspection_c__Trigger_service_type_support_handle.typesupport_identifier) {
    std_srvs__srv__trigger__rosidl_typesupport_introspection_c__Trigger_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)std_srvs__srv__trigger__rosidl_typesupport_introspection_c__Trigger_service_type_support_handle.data;
  ...
  return &std_srvs__srv__trigger__rosidl_typesupport_introspection_c__Trigger_service_type_support_handle;
}
