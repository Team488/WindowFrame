...
#ifndef TF2_MSGS__ACTION__LOOKUP_TRANSFORM__STRUCT_H_
#define TF2_MSGS__ACTION__LOOKUP_TRANSFORM__STRUCT_H_
...
{
  rosidl_generator_c__String target_frame;
  rosidl_generator_c__String source_frame;
  ...
  rosidl_generator_c__String fixed_frame;
  bool advanced;
...
#endif  // TF2_MSGS__ACTION__LOOKUP_TRANSFORM__STRUCT_H_
