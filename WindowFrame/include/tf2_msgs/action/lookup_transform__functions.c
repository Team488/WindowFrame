...
tf2_msgs__action__LookupTransform_Goal__init(tf2_msgs__action__LookupTransform_Goal * msg)
{
  ...
  // target_frame
  if (!rosidl_generator_c__String__init(&msg->target_frame)) {
    tf2_msgs__action__LookupTransform_Goal__destroy(msg);
    return false;
  }
  // source_frame
  if (!rosidl_generator_c__String__init(&msg->source_frame)) {
    tf2_msgs__action__LookupTransform_Goal__destroy(msg);
    return false;
  }
  // source_time
  ...
  // fixed_frame
  if (!rosidl_generator_c__String__init(&msg->fixed_frame)) {
    tf2_msgs__action__LookupTransform_Goal__destroy(msg);
    return false;
  }
  // advanced
...
tf2_msgs__action__LookupTransform_Goal__fini(tf2_msgs__action__LookupTransform_Goal * msg)
{
  ...
  // target_frame
  rosidl_generator_c__String__fini(&msg->target_frame);
  // source_frame
  rosidl_generator_c__String__fini(&msg->source_frame);
  // source_time
  ...
  // fixed_frame
  rosidl_generator_c__String__fini(&msg->fixed_frame);
  // advanced
}
