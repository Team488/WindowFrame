...
#ifndef TF2_MSGS__SRV__FRAME_GRAPH__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
#define TF2_MSGS__SRV__FRAME_GRAPH__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
// generated from
...
#include "tf2_msgs/srv/dds_opensplice/ccpp_FrameGraph_.h"
...
const char *
serialize__FrameGraph_Request(
  const void * untyped_ros_message,
  void * serialized_data);

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_tf2_msgs
const char *
deserialize__FrameGraph_Request(
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_tf2_msgs
extern void register_type__FrameGraph_Response(
  DDS::DomainParticipant * participant,
  const char * type_name);
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_tf2_msgs
extern void publish__FrameGraph_Response(
  DDS::DataWriter * topic_writer,
  const void * untyped_ros_message);
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_tf2_msgs
extern bool take__FrameGraph_Response(
  DDS::DataReader * topic_reader,
  bool ignore_local_publications,
  void * untyped_ros_message,
  bool * taken);
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_tf2_msgs
const char *
serialize__FrameGraph_Response(
  const void * untyped_ros_message,
  void * serialized_data);

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_tf2_msgs
const char *
deserialize__FrameGraph_Response(
  const uint8_t * buffer,
  unsigned length,
  void * untyped_ros_message);
...
#endif
#endif  // TF2_MSGS__SRV__FRAME_GRAPH__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
