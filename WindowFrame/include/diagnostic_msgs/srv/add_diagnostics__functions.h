...
#ifndef DIAGNOSTIC_MSGS__SRV__ADD_DIAGNOSTICS__FUNCTIONS_H_
#define DIAGNOSTIC_MSGS__SRV__ADD_DIAGNOSTICS__FUNCTIONS_H_
...
#endif  // DIAGNOSTIC_MSGS__SRV__ADD_DIAGNOSTICS__FUNCTIONS_H_
