...
#ifndef DIAGNOSTIC_MSGS__SRV__ADD_DIAGNOSTICS__STRUCT_HPP_
#define DIAGNOSTIC_MSGS__SRV__ADD_DIAGNOSTICS__STRUCT_HPP_
...
struct AddDiagnostics_Response_
{
  ...
  explicit AddDiagnostics_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit AddDiagnostics_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : message(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // DIAGNOSTIC_MSGS__SRV__ADD_DIAGNOSTICS__STRUCT_HPP_
