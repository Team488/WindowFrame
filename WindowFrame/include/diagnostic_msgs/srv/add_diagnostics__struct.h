...
#ifndef DIAGNOSTIC_MSGS__SRV__ADD_DIAGNOSTICS__STRUCT_H_
#define DIAGNOSTIC_MSGS__SRV__ADD_DIAGNOSTICS__STRUCT_H_
...
#endif  // DIAGNOSTIC_MSGS__SRV__ADD_DIAGNOSTICS__STRUCT_H_
