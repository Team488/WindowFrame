...
#include "diagnostic_msgs/srv/add_diagnostics__functions.h"
#include "diagnostic_msgs/srv/add_diagnostics__struct.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers diagnostic_msgs__srv__add_diagnostics__rosidl_typesupport_introspection_c__AddDiagnostics_service_members = {
  "diagnostic_msgs__srv",  // service namespace
  "AddDiagnostics",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // diagnostic_msgs__srv__add_diagnostics__rosidl_typesupport_introspection_c__AddDiagnostics_Request_message_type_support_handle,
  NULL  // response message
  // diagnostic_msgs__srv__add_diagnostics__rosidl_typesupport_introspection_c__AddDiagnostics_Response_message_type_support_handle
};

static rosidl_service_type_support_t diagnostic_msgs__srv__add_diagnostics__rosidl_typesupport_introspection_c__AddDiagnostics_service_type_support_handle = {
  0,
  &diagnostic_msgs__srv__add_diagnostics__rosidl_typesupport_introspection_c__AddDiagnostics_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, diagnostic_msgs, srv, AddDiagnostics)() {
  if (!diagnostic_msgs__srv__add_diagnostics__rosidl_typesupport_introspection_c__AddDiagnostics_service_type_support_handle.typesupport_identifier) {
    diagnostic_msgs__srv__add_diagnostics__rosidl_typesupport_introspection_c__AddDiagnostics_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)diagnostic_msgs__srv__add_diagnostics__rosidl_typesupport_introspection_c__AddDiagnostics_service_type_support_handle.data;
  ...
  return &diagnostic_msgs__srv__add_diagnostics__rosidl_typesupport_introspection_c__AddDiagnostics_service_type_support_handle;
}
