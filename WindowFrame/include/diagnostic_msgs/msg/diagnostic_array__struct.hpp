...
#ifndef DIAGNOSTIC_MSGS__MSG__DIAGNOSTIC_ARRAY__STRUCT_HPP_
#define DIAGNOSTIC_MSGS__MSG__DIAGNOSTIC_ARRAY__STRUCT_HPP_
...
struct DiagnosticArray_
{
  ...
  explicit DiagnosticArray_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit DiagnosticArray_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // DIAGNOSTIC_MSGS__MSG__DIAGNOSTIC_ARRAY__STRUCT_HPP_
