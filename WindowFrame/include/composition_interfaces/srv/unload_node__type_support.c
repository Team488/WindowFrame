...
#include "composition_interfaces/srv/unload_node__functions.h"
...
void UnloadNode_Request__rosidl_typesupport_introspection_c__UnloadNode_Request_init_function(
...
void UnloadNode_Request__rosidl_typesupport_introspection_c__UnloadNode_Request_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers UnloadNode_Request__rosidl_typesupport_introspection_c__UnloadNode_Request_message_members = {
  ...
  UnloadNode_Request__rosidl_typesupport_introspection_c__UnloadNode_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  UnloadNode_Request__rosidl_typesupport_introspection_c__UnloadNode_Request_fini_function  // function to terminate message instance (will not free memory)
};
...
void UnloadNode_Response__rosidl_typesupport_introspection_c__UnloadNode_Response_init_function(
  void * message_memory, enum rosidl_runtime_c_message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void UnloadNode_Response__rosidl_typesupport_introspection_c__UnloadNode_Response_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers UnloadNode_Response__rosidl_typesupport_introspection_c__UnloadNode_Response_message_members = {
  ...
  UnloadNode_Response__rosidl_typesupport_introspection_c__UnloadNode_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  UnloadNode_Response__rosidl_typesupport_introspection_c__UnloadNode_Response_fini_function  // function to terminate message instance (will not free memory)
};
