...
#ifndef COMPOSITION_INTERFACES__SRV__LOAD_NODE__STRUCT_HPP_
#define COMPOSITION_INTERFACES__SRV__LOAD_NODE__STRUCT_HPP_
...
struct LoadNode_Request_
{
  ...
  explicit LoadNode_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit LoadNode_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : package_name(_alloc),
    plugin_name(_alloc),
    node_name(_alloc),
...
struct LoadNode_Response_
{
  ...
  explicit LoadNode_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit LoadNode_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // COMPOSITION_INTERFACES__SRV__LOAD_NODE__STRUCT_HPP_
