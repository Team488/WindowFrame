...
#ifndef COMPOSITION_INTERFACES__SRV__LIST_NODES__STRUCT_H_
#define COMPOSITION_INTERFACES__SRV__LIST_NODES__STRUCT_H_
...
{
  rosidl_generator_c__String__Sequence full_node_names;
  rosidl_generator_c__uint64__Sequence unique_ids;
...
#endif  // COMPOSITION_INTERFACES__SRV__LIST_NODES__STRUCT_H_
