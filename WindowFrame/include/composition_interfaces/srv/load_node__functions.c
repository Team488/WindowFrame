...
composition_interfaces__srv__LoadNode_Request__init(composition_interfaces__srv__LoadNode_Request * msg)
{
  ...
  // package_name
  if (!rosidl_generator_c__String__init(&msg->package_name)) {
    composition_interfaces__srv__LoadNode_Request__destroy(msg);
    return false;
  }
  // plugin_name
  if (!rosidl_generator_c__String__init(&msg->plugin_name)) {
    composition_interfaces__srv__LoadNode_Request__destroy(msg);
    return false;
  }
  // node_name
  ...
  // node_namespace
  if (!rosidl_generator_c__String__init(&msg->node_namespace)) {
    composition_interfaces__srv__LoadNode_Request__destroy(msg);
    return false;
  }
  // log_level
  // remap_rules
  if (!rosidl_generator_c__String__Sequence__init(&msg->remap_rules, 0)) {
    composition_interfaces__srv__LoadNode_Request__destroy(msg);
    return false;
  }
  // parameters
...
composition_interfaces__srv__LoadNode_Request__fini(composition_interfaces__srv__LoadNode_Request * msg)
{
  ...
  // node_namespace
  rosidl_generator_c__String__fini(&msg->node_namespace);
  // log_level
  // remap_rules
  rosidl_generator_c__String__Sequence__fini(&msg->remap_rules);
  // parameters
...
composition_interfaces__srv__LoadNode_Response__init(composition_interfaces__srv__LoadNode_Response * msg)
{
  ...
  // full_node_name
  if (!rosidl_generator_c__String__init(&msg->full_node_name)) {
    composition_interfaces__srv__LoadNode_Response__destroy(msg);
    return false;
  }
  // unique_id
...
composition_interfaces__srv__LoadNode_Response__fini(composition_interfaces__srv__LoadNode_Response * msg)
{
  ...
  // full_node_name
  rosidl_generator_c__String__fini(&msg->full_node_name);
  // unique_id
}
