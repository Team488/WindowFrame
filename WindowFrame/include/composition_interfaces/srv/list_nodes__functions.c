...
composition_interfaces__srv__ListNodes_Response__init(composition_interfaces__srv__ListNodes_Response * msg)
{
  ...
  // full_node_names
  if (!rosidl_generator_c__String__Sequence__init(&msg->full_node_names, 0)) {
    composition_interfaces__srv__ListNodes_Response__destroy(msg);
    return false;
  }
  // unique_ids
  if (!rosidl_generator_c__uint64__Sequence__init(&msg->unique_ids, 0)) {
    composition_interfaces__srv__ListNodes_Response__destroy(msg);
    return false;
  }
  return true;
...
composition_interfaces__srv__ListNodes_Response__fini(composition_interfaces__srv__ListNodes_Response * msg)
{
  ...
  // full_node_names
  rosidl_generator_c__String__Sequence__fini(&msg->full_node_names);
  // unique_ids
  rosidl_generator_c__uint64__Sequence__fini(&msg->unique_ids);
}
