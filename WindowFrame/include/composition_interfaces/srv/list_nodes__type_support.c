...
#include <stddef.h>
#include "composition_interfaces/srv/list_nodes__rosidl_typesupport_introspection_c.h"
...
#include "composition_interfaces/srv/list_nodes__functions.h"
#include "composition_interfaces/srv/list_nodes__struct.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers composition_interfaces__srv__list_nodes__rosidl_typesupport_introspection_c__ListNodes_service_members = {
  "composition_interfaces__srv",  // service namespace
  "ListNodes",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // composition_interfaces__srv__list_nodes__rosidl_typesupport_introspection_c__ListNodes_Request_message_type_support_handle,
  NULL  // response message
  // composition_interfaces__srv__list_nodes__rosidl_typesupport_introspection_c__ListNodes_Response_message_type_support_handle
};

static rosidl_service_type_support_t composition_interfaces__srv__list_nodes__rosidl_typesupport_introspection_c__ListNodes_service_type_support_handle = {
  0,
  &composition_interfaces__srv__list_nodes__rosidl_typesupport_introspection_c__ListNodes_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, composition_interfaces, srv, ListNodes)() {
  if (!composition_interfaces__srv__list_nodes__rosidl_typesupport_introspection_c__ListNodes_service_type_support_handle.typesupport_identifier) {
    composition_interfaces__srv__list_nodes__rosidl_typesupport_introspection_c__ListNodes_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)composition_interfaces__srv__list_nodes__rosidl_typesupport_introspection_c__ListNodes_service_type_support_handle.data;
  ...
  return &composition_interfaces__srv__list_nodes__rosidl_typesupport_introspection_c__ListNodes_service_type_support_handle;
}
