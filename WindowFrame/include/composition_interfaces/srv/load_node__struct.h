...
#ifndef COMPOSITION_INTERFACES__SRV__LOAD_NODE__STRUCT_H_
#define COMPOSITION_INTERFACES__SRV__LOAD_NODE__STRUCT_H_
...
typedef struct composition_interfaces__srv__LoadNode_Request
{
  ...
  rosidl_generator_c__String node_namespace;
  uint8_t log_level;
  rosidl_generator_c__String__Sequence remap_rules;
...
typedef struct composition_interfaces__srv__LoadNode_Response
{
  ...
  rosidl_generator_c__String full_node_name;
  uint64_t unique_id;
...
#endif  // COMPOSITION_INTERFACES__SRV__LOAD_NODE__STRUCT_H_
