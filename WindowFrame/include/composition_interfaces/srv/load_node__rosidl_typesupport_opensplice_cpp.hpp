...
#ifndef COMPOSITION_INTERFACES__SRV__LOAD_NODE__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
#define COMPOSITION_INTERFACES__SRV__LOAD_NODE__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
// generated from
...
#include "composition_interfaces/srv/load_node__struct.hpp"
#include "composition_interfaces/srv/dds_opensplice/ccpp_LoadNode_.h"
...
const char *
serialize__LoadNode_Request(
  const void * untyped_ros_message,
  void * serialized_data);

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_composition_interfaces
const char *
deserialize__LoadNode_Request(
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_composition_interfaces
const char *
serialize__LoadNode_Response(
  const void * untyped_ros_message,
  void * serialized_data);

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_composition_interfaces
const char *
deserialize__LoadNode_Response(
  const uint8_t * buffer,
  unsigned length,
  void * untyped_ros_message);
...
#endif
#endif  // COMPOSITION_INTERFACES__SRV__LOAD_NODE__ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_HPP_
