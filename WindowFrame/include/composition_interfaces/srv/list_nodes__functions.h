...
#ifndef COMPOSITION_INTERFACES__SRV__LIST_NODES__FUNCTIONS_H_
#define COMPOSITION_INTERFACES__SRV__LIST_NODES__FUNCTIONS_H_
...
#endif  // COMPOSITION_INTERFACES__SRV__LIST_NODES__FUNCTIONS_H_
