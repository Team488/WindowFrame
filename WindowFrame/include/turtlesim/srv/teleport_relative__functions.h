...
#ifndef TURTLESIM__SRV__TELEPORT_RELATIVE__FUNCTIONS_H_
#define TURTLESIM__SRV__TELEPORT_RELATIVE__FUNCTIONS_H_
...
#endif  // TURTLESIM__SRV__TELEPORT_RELATIVE__FUNCTIONS_H_
