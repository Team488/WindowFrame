#ifndef H_1F29DEF4026727290853A2C257497F31_SetPen_SPLTYPES_H
#define H_1F29DEF4026727290853A2C257497F31_SetPen_SPLTYPES_H
...
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim v_copyin_result __turtlesim_srv_dds__SetPen_Request___copyIn(c_base base, const struct turtlesim::srv::dds_::SetPen_Request_ *from, struct _turtlesim_srv_dds__SetPen_Request_ *to);
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim void __turtlesim_srv_dds__SetPen_Request___copyOut(const void *_from, void *_to);
struct _turtlesim_srv_dds__SetPen_Request_ {
    c_octet r_;
    c_octet g_;
    c_octet b_;
...
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim v_copyin_result __turtlesim_srv_dds__SetPen_Response___copyIn(c_base base, const struct turtlesim::srv::dds_::SetPen_Response_ *from, struct _turtlesim_srv_dds__SetPen_Response_ *to);
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim void __turtlesim_srv_dds__SetPen_Response___copyOut(const void *_from, void *_to);
struct _turtlesim_srv_dds__SetPen_Response_ {
...
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim v_copyin_result __turtlesim_srv_dds__Sample_SetPen_Request___copyIn(c_base base, const struct turtlesim::srv::dds_::Sample_SetPen_Request_ *from, struct _turtlesim_srv_dds__Sample_SetPen_Request_ *to);
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim void __turtlesim_srv_dds__Sample_SetPen_Request___copyOut(const void *_from, void *_to);
struct _turtlesim_srv_dds__Sample_SetPen_Request_ {
...
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim v_copyin_result __turtlesim_srv_dds__Sample_SetPen_Response___copyIn(c_base base, const struct turtlesim::srv::dds_::Sample_SetPen_Response_ *from, struct _turtlesim_srv_dds__Sample_SetPen_Response_ *to);
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim void __turtlesim_srv_dds__Sample_SetPen_Response___copyOut(const void *_from, void *_to);
struct _turtlesim_srv_dds__Sample_SetPen_Response_ {
    c_ulonglong client_guid_0_;
    c_ulonglong client_guid_1_;
    c_longlong sequence_number_;
