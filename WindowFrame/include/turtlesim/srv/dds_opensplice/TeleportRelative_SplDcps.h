#ifndef H_EA00280E7D255566FFF5D1D027EF52C8_TeleportRelative_SPLTYPES_H
#define H_EA00280E7D255566FFF5D1D027EF52C8_TeleportRelative_SPLTYPES_H
...
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim v_copyin_result __turtlesim_srv_dds__TeleportRelative_Request___copyIn(c_base base, const struct turtlesim::srv::dds_::TeleportRelative_Request_ *from, struct _turtlesim_srv_dds__TeleportRelative_Request_ *to);
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim void __turtlesim_srv_dds__TeleportRelative_Request___copyOut(const void *_from, void *_to);
struct _turtlesim_srv_dds__TeleportRelative_Request_ {
    c_float linear_;
    c_float angular_;
};
...
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim v_copyin_result __turtlesim_srv_dds__TeleportRelative_Response___copyIn(c_base base, const struct turtlesim::srv::dds_::TeleportRelative_Response_ *from, struct _turtlesim_srv_dds__TeleportRelative_Response_ *to);
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim void __turtlesim_srv_dds__TeleportRelative_Response___copyOut(const void *_from, void *_to);
struct _turtlesim_srv_dds__TeleportRelative_Response_ {
...
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim v_copyin_result __turtlesim_srv_dds__Sample_TeleportRelative_Request___copyIn(c_base base, const struct turtlesim::srv::dds_::Sample_TeleportRelative_Request_ *from, struct _turtlesim_srv_dds__Sample_TeleportRelative_Request_ *to);
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim void __turtlesim_srv_dds__Sample_TeleportRelative_Request___copyOut(const void *_from, void *_to);
struct _turtlesim_srv_dds__Sample_TeleportRelative_Request_ {
...
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim v_copyin_result __turtlesim_srv_dds__Sample_TeleportRelative_Response___copyIn(c_base base, const struct turtlesim::srv::dds_::Sample_TeleportRelative_Response_ *from, struct _turtlesim_srv_dds__Sample_TeleportRelative_Response_ *to);
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim void __turtlesim_srv_dds__Sample_TeleportRelative_Response___copyOut(const void *_from, void *_to);
struct _turtlesim_srv_dds__Sample_TeleportRelative_Response_ {
    c_ulonglong client_guid_0_;
    c_ulonglong client_guid_1_;
    c_longlong sequence_number_;
