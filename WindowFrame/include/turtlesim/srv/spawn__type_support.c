...
static rosidl_typesupport_introspection_c__ServiceMembers turtlesim__srv__spawn__rosidl_typesupport_introspection_c__Spawn_service_members = {
  "turtlesim__srv",  // service namespace
  "Spawn",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // turtlesim__srv__spawn__rosidl_typesupport_introspection_c__Spawn_Request_message_type_support_handle,
  NULL  // response message
  // turtlesim__srv__spawn__rosidl_typesupport_introspection_c__Spawn_Response_message_type_support_handle
};

static rosidl_service_type_support_t turtlesim__srv__spawn__rosidl_typesupport_introspection_c__Spawn_service_type_support_handle = {
  0,
  &turtlesim__srv__spawn__rosidl_typesupport_introspection_c__Spawn_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim, srv, Spawn)() {
  if (!turtlesim__srv__spawn__rosidl_typesupport_introspection_c__Spawn_service_type_support_handle.typesupport_identifier) {
    turtlesim__srv__spawn__rosidl_typesupport_introspection_c__Spawn_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)turtlesim__srv__spawn__rosidl_typesupport_introspection_c__Spawn_service_type_support_handle.data;
  ...
  return &turtlesim__srv__spawn__rosidl_typesupport_introspection_c__Spawn_service_type_support_handle;
}
