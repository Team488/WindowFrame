...
#ifndef TURTLESIM__SRV__TELEPORT_ABSOLUTE__STRUCT_H_
#define TURTLESIM__SRV__TELEPORT_ABSOLUTE__STRUCT_H_
...
#endif  // TURTLESIM__SRV__TELEPORT_ABSOLUTE__STRUCT_H_
