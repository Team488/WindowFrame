...
#include <stddef.h>
#include "turtlesim/srv/teleport_absolute__rosidl_typesupport_introspection_c.h"
#include "turtlesim/msg/rosidl_typesupport_introspection_c__visibility_control.h"
#include "rosidl_typesupport_introspection_c/field_types.h"
#include "rosidl_typesupport_introspection_c/identifier.h"
#include "rosidl_typesupport_introspection_c/message_introspection.h"
#include "turtlesim/srv/teleport_absolute__functions.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers turtlesim__srv__teleport_absolute__rosidl_typesupport_introspection_c__TeleportAbsolute_service_members = {
  "turtlesim__srv",  // service namespace
  "TeleportAbsolute",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // turtlesim__srv__teleport_absolute__rosidl_typesupport_introspection_c__TeleportAbsolute_Request_message_type_support_handle,
  NULL  // response message
  // turtlesim__srv__teleport_absolute__rosidl_typesupport_introspection_c__TeleportAbsolute_Response_message_type_support_handle
};

static rosidl_service_type_support_t turtlesim__srv__teleport_absolute__rosidl_typesupport_introspection_c__TeleportAbsolute_service_type_support_handle = {
  0,
  &turtlesim__srv__teleport_absolute__rosidl_typesupport_introspection_c__TeleportAbsolute_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim, srv, TeleportAbsolute)() {
  if (!turtlesim__srv__teleport_absolute__rosidl_typesupport_introspection_c__TeleportAbsolute_service_type_support_handle.typesupport_identifier) {
    turtlesim__srv__teleport_absolute__rosidl_typesupport_introspection_c__TeleportAbsolute_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)turtlesim__srv__teleport_absolute__rosidl_typesupport_introspection_c__TeleportAbsolute_service_type_support_handle.data;
  ...
  return &turtlesim__srv__teleport_absolute__rosidl_typesupport_introspection_c__TeleportAbsolute_service_type_support_handle;
}
