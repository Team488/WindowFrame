...
#ifndef TURTLESIM__SRV__TELEPORT_ABSOLUTE__TYPE_SUPPORT_H_
#define TURTLESIM__SRV__TELEPORT_ABSOLUTE__TYPE_SUPPORT_H_
...
#endif  // TURTLESIM__SRV__TELEPORT_ABSOLUTE__TYPE_SUPPORT_H_
