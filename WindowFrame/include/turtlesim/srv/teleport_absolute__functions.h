...
#ifndef TURTLESIM__SRV__TELEPORT_ABSOLUTE__FUNCTIONS_H_
#define TURTLESIM__SRV__TELEPORT_ABSOLUTE__FUNCTIONS_H_
...
#endif  // TURTLESIM__SRV__TELEPORT_ABSOLUTE__FUNCTIONS_H_
