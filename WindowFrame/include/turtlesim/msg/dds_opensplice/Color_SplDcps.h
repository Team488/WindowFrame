#ifndef H_DD1FB52DBD70A855A11FE0C8DA122477_Color_SPLTYPES_H
#define H_DD1FB52DBD70A855A11FE0C8DA122477_Color_SPLTYPES_H
...
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim v_copyin_result __turtlesim_msg_dds__Color___copyIn(c_base base, const struct turtlesim::msg::dds_::Color_ *from, struct _turtlesim_msg_dds__Color_ *to);
extern ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_PUBLIC_turtlesim void __turtlesim_msg_dds__Color___copyOut(const void *_from, void *_to);
struct _turtlesim_msg_dds__Color_ {
    c_octet r_;
    c_octet g_;
    c_octet b_;
