...
#ifndef TURTLESIM__ACTION__ROTATE_ABSOLUTE__FUNCTIONS_H_
#define TURTLESIM__ACTION__ROTATE_ABSOLUTE__FUNCTIONS_H_
...
#endif  // TURTLESIM__ACTION__ROTATE_ABSOLUTE__FUNCTIONS_H_
