...
#ifndef TURTLESIM__ACTION__ROTATE_ABSOLUTE__TYPE_SUPPORT_H_
#define TURTLESIM__ACTION__ROTATE_ABSOLUTE__TYPE_SUPPORT_H_
...
#endif  // TURTLESIM__ACTION__ROTATE_ABSOLUTE__TYPE_SUPPORT_H_
