...
#include <stddef.h>
#include "turtlesim/action/rotate_absolute__rosidl_typesupport_introspection_c.h"
#include "turtlesim/msg/rosidl_typesupport_introspection_c__visibility_control.h"
#include "rosidl_typesupport_introspection_c/field_types.h"
#include "rosidl_typesupport_introspection_c/identifier.h"
#include "rosidl_typesupport_introspection_c/message_introspection.h"
#include "turtlesim/action/rotate_absolute__functions.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_SendGoal_service_members = {
  "turtlesim__action",  // service namespace
  "RotateAbsolute_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_SendGoal_service_type_support_handle = {
  0,
  &turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim, action, RotateAbsolute_SendGoal)() {
  if (!turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_SendGoal_service_type_support_handle.typesupport_identifier) {
    turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_SendGoal_service_type_support_handle.data;
  ...
  return &turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_SendGoal_service_type_support_handle;
}
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_GetResult_service_members = {
  "turtlesim__action",  // service namespace
  "RotateAbsolute_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_GetResult_service_type_support_handle = {
  0,
  &turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim, action, RotateAbsolute_GetResult)() {
  if (!turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_GetResult_service_type_support_handle.typesupport_identifier) {
    turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_GetResult_service_type_support_handle.data;
  ...
  return &turtlesim__action__rotate_absolute__rosidl_typesupport_introspection_c__RotateAbsolute_GetResult_service_type_support_handle;
}
