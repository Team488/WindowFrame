...
#ifndef TURTLESIM__ACTION__ROTATE_ABSOLUTE__STRUCT_H_
#define TURTLESIM__ACTION__ROTATE_ABSOLUTE__STRUCT_H_
...
#endif  // TURTLESIM__ACTION__ROTATE_ABSOLUTE__STRUCT_H_
