...
#ifndef Fibonacci__1767533685_h
#define Fibonacci__1767533685_h
...
namespace action_tutorials {
    namespace action {
        namespace dds_ {
            ...
            #if (defined(RTI_WIN32) || defined (RTI_WINCE)) && defined(NDDS_USER_DLL_EXPORT_action_tutorials)
