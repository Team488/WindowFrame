...
#ifndef MOVE_BASE_MSGS__ACTION__MOVE_BASE__TYPE_SUPPORT_H_
#define MOVE_BASE_MSGS__ACTION__MOVE_BASE__TYPE_SUPPORT_H_
...
#endif  // MOVE_BASE_MSGS__ACTION__MOVE_BASE__TYPE_SUPPORT_H_
