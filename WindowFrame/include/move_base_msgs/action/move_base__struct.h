...
#ifndef MOVE_BASE_MSGS__ACTION__MOVE_BASE__STRUCT_H_
#define MOVE_BASE_MSGS__ACTION__MOVE_BASE__STRUCT_H_
...
#endif  // MOVE_BASE_MSGS__ACTION__MOVE_BASE__STRUCT_H_
