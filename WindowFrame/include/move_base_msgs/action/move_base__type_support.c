...
#include <stddef.h>
#include "move_base_msgs/action/move_base__rosidl_typesupport_introspection_c.h"
#include "move_base_msgs/msg/rosidl_typesupport_introspection_c__visibility_control.h"
#include "rosidl_typesupport_introspection_c/field_types.h"
#include "rosidl_typesupport_introspection_c/identifier.h"
#include "rosidl_typesupport_introspection_c/message_introspection.h"
#include "move_base_msgs/action/move_base__functions.h"
#include "move_base_msgs/action/move_base__struct.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_SendGoal_service_members = {
  "move_base_msgs__action",  // service namespace
  "MoveBase_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_SendGoal_service_type_support_handle = {
  0,
  &move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, move_base_msgs, action, MoveBase_SendGoal)() {
  if (!move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_SendGoal_service_type_support_handle.typesupport_identifier) {
    move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_SendGoal_service_type_support_handle.data;
  ...
  return &move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_SendGoal_service_type_support_handle;
}
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_GetResult_service_members = {
  "move_base_msgs__action",  // service namespace
  "MoveBase_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_GetResult_service_type_support_handle = {
  0,
  &move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, move_base_msgs, action, MoveBase_GetResult)() {
  if (!move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_GetResult_service_type_support_handle.typesupport_identifier) {
    move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_GetResult_service_type_support_handle.data;
  ...
  return &move_base_msgs__action__move_base__rosidl_typesupport_introspection_c__MoveBase_GetResult_service_type_support_handle;
}
